...
//			  System.out.println(container.getAtomCount()+"\t"+container.getBondCount());
	...
	public static void main(String[] args) {
		...
		String folder="C:\\Users\\TMARTI02\\OneDrive - Environmental Protection Agency (EPA)\\Comptox\\0 toxicity endpoint data\\skin sensitization";
