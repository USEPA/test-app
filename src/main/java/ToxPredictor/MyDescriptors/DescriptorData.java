...
public class DescriptorData {
	...
	// TODO- use better way to store all the variables and fragment counts
	...
	public String molname = ""; // chemical name
...
//	public double SdaaS;   // Sum of all ( daaS ) E-state values in the molecule (not in MDL QSAR, omit???)
	...
	public double SddsAs; // Sum of all ( ddsAs ) E-state values in the molecule (not in MDL QSAR,
							// omit???)
...
//	public int SdaaS_acnt;   // Count of all ( daaS ) groups in molecule (not in MDL QSAR, omit???)
	...
	public double SHother;// Sum of all Hydrogen E-State values for all atom types in the molecule other
							// than specified in the list of H E-state indices.
	public double SHCHnX; // Sum of the Hydrogen E-State values for all CH or CH2 groups with a -F or -Cl
...
//	D.	Maximum and Minimum Values
	...
	public static String[] strFragments = { // used to output fragment in organized fashion
			// Arsenic:
			"As [+5 valence, one double bond]", "As [+5 valence, all single bonds]",
			"As [+5 valence, two double bonds]", "As [+3 valence, one double bond]",
			"As [+3 valence, all single bonds]", "As",

			// Boron:
			"B",

			// Bromine:
			"-Br [aliphatic attach]", "-Br [aromatic attach]", "-Br [olefinic attach]",

			// Carbon:
			"-CH3 [aliphatic attach]", "-CH3 [aromatic attach]", "-CH2- [aliphatic attach]", "-CH2- [aromatic attach]",
			"-CH< [aliphatic attach]", "-CH< [aromatic attach]", ">C< [aliphatic attach]", ">C< [aromatic attach]",
			"=CH2 [aliphatic attach]", "-CH= [aromatic attach]", "=CH [aliphatic attach]", "=C [aliphatic attach]",
			">C= [aromatic attach]", "#C [aliphatic attach]", "-C# [aromatic attach]", "#CH [aliphatic attach]", "=C=",
			"ACH", "AC", "Fused aromatic carbon", "ACAC",

			// chlorine:
			"-Cl [aliphatic attach]", "-Cl [aromatic attach]", "-Cl [olefinic attach]",

			// Fluorine:
			"-F [aliphatic attach]", "-F [aromatic attach]", "-F [olefinic attach]",

			// Hydrogen:
			"H [carbon attach]", "H [phosphorus attach]", "H [nitrogen attach]", "H [silicon attach]", "H [other]",

			// Iodine:
			"-I [aliphatic attach]", "-I [aromatic attach]", "-I [olefinic attach]",
			...
			// Oxygen
			"-O- [nitrogen attach]", "-O- [phosphorus attach]", "-O- [arsenic attach]", "-O- [aromatic attach]",
			"-O- [oxygen attach]", "-O- [sulfur attach]", "-O- (epoxide)", "-O- [2 aromatic attach]",
			"-O- [phosphorus, aromatic attach]", "-O- [2 phosphorus attach]", "-O- [aliphatic attach]", "=O [other]",
			"-OH [phosphorus attach]", "-OH [sulfur attach]", "-OH [arsenic attach]", "-OH [aliphatic attach]",
			"-OH [nitrogen attach]", "-OH [oxygen attach]", "-OH [aromatic attach]", "AO", "-[O-]",

			// Nitrogen:
			"-NH2 [aliphatic attach]", "-NH2 [aromatic attach]", "-NH2 [nitrogen attach]", "-NH2 [attached to P]",
			"-NH- [aliphatic attach]", "-NH- [aromatic attach]", "-NH- [3 membered ring]", "-NH- [attached to P]",
			"-NH- [nitrogen attach]", "-N< [aliphatic attach]", "-N< [aromatic attach]", "-N< [nitrogen attach]",
			"-N< [attached to P]", "-N< [3 membered ring]", "N+ [four single bonds]", "AN+", "AN", "ANH",
			"ANH [attached to AN in same ring]", "AN [attached to AN in same ring]", "Fused aromatic nitrogen",
			"-[N+]#N", "-N=[N+]=[N-]", "-N=NH", "-N=N-",

			// Phosphorus:
			"P [+5 valence, two double bonds]", "P [+5 valence, one double bond]", "P [+5 valence, all single bonds]",
			"P [+3 valence, all single bonds]", "P",

			// Sulfur
			"-SH [aliphatic attach]", "-SH [aromatic attach]", "-S- [aromatic attach]", "-S- [three membered ring]",
			"-S- [2 aromatic attach]", "-S- [nitrogen attach]", "-S- [sulfur attach]", "-S- [aliphatic attach]",
			"-S- [arsenic attach]", "-S- [phosphorus attach]", "=S [other]", "->S<-", "AS",

			// Silicon:
			"Si [aromatic attach]", "Si [oxygen, aromatic attach]", "Si [oxygen attach]", "Si",

			// Tin:
			"Sn [oxygen attach]", "Sn [aromatic attach]", "Sn",

			// *****************************************
			// Multi atom fragments:
			// carbon + nitrogen
			"-C#N [aliphatic attach]", "-C#N [aromatic attach]", "-C#N [olefinic attach]", "CH2=N", "-CH=NH", "-CH=N",
			">C=NH", ">C=N", ">C(=N) [Nitrogen attach]", "[C-]#[N+]", "C=[N+]=[N-]", ">C(=N) [2 Nitrogen attach]",
			"-C([H])=N [Nitrogen attach]", "-C([H])=N[H] [Nitrogen attach]", ">C=N[H] [2 Nitrogen attach]",
			">C=N[H] [Nitrogen attach]", "N=C=N", "HN=C=N", "-C#N [aliphatic sulfur attach]",
			"-C#N [aliphatic nitrogen attach]",

			// Carbon + oxygen:
			"C=O(ketone, aliphatic attach)", "-C(=O)- [aromatic attach]", "-C(=O)- [phosphorus attach]",
			"-C(=O)- [halogen attach]", "-C(=O)- [2 nitrogen attach]", "-C(=O)- [nitrogen, aliphatic attach]",
			"-C(=O)- [olefinic attach]", "-C(=O)- [nitrogen, aromatic attach]", "-C(=O)- [2 aromatic attach]",
			"C=O(non-ketone, aliphatic attach)", "-COOH [aliphatic attach]", "-COOH [aromatic attach]",
			"-CHO [aliphatic attach]", "-CHO [aromatic attach]", "-CHO [nitrogen attach]", "-C(=O)O- [olefinic attach]",
			"-C(=O)O- [aromatic attach]", "-C(=O)O- [aliphatic attach]", "-C(=O)O- [nitrogen attach]",
			"-C(=O)O- [cyclic]", "HC(=O)O-", "-C(=O)OC(=O)-", "-C(=O)[O-]", "-OC(=O)O-", "C=C=O", "CH2=C(CH3)C(=O)O-",
			"CH2=CHC(=O)O-",

			// carbon + sulfur:
			"-C(=S)- [aliphatic attach]", "-C(=S)- [aromatic attach]", "-C(=S)- [nitrogen, aliphatic attach]",
			"-C(=S)- [nitrogen, aromatic attach]", "-C(=S)- [2 nitrogen attach]", "-C(=S)S- [aliphatic attach]",
			"-C(=S)S- [aromatic attach]", "-C(=S)S- [nitrogen attach]", "-C(=S)SH [aliphatic attach]",
			"-C(=S)SH [aromatic attach]", "-C(=S)SH [nitrogen attach]", "-SC(=S)S-", "S=C=S",

			// carbon + oxygen + sulfur:
			"-C(=S)OH [aliphatic attach]", "-C(=S)OH [aromatic attach]", "-C(=S)O- [aliphatic attach]",
			"-C(=S)O- [aromatic attach]", "-C(=S)O- [nitrogen attach]", "-C(=O)SH [aliphatic attach]",
			"-C(=O)SH [aromatic attach]", "-C(=O)SH [nitrogen attach]", "-C(=O)S- [aliphatic attach]",
			"-C(=O)S- [aromatic attach]", "-C(=O)S- [nitrogen attach]", "-OC(=S)O-", "-SC(=S)O-", "-SC(=O)S-",
			"-SC(=O)O-",

			// carbon + nitrogen + oxygen
			">C=NOH", ">C=NO", "-CH=NOH", "-CH=NO", "-N=C=O [aliphatic attach]", "-N=C=O [aromatic attach]",
			"C=[N+][O-]",

			// nitrogen + oxygen:
			"-ONO2", "-N=[N+][O-]", "-NO2 [aliphatic attach]", "-NO2 [aromatic attach]", "-NO2 [nitrogen attach]",
			"-NO2 [olefinic attach]", "A[N+][O-]", "-NHN=O", ">NN=O", "-N=O [aromatic attach]", "-N(=O)",

			// oxygen + sulfur:
			"-S(=O)- [aliphatic attach]", "-S(=O)- [aromatic attach]", "-S(=O)- [nitrogen, aromatic attach]",
			"-S(=O)- olefinic attach]", "-S(=O)- [2 nitrogen attach]", "-S(=O)- [nitrogen, aliphatic attach]",
			"-S(=O)(=O)- [nitrogen, aromatic attach]", "-S(=O)(=O)- [nitrogen, aliphatic attach]",
			"-S(=O)(=O)- [olefinic attach]", "-S(=O)(=O)- [2 nitrogen attach]", "-S(=O)(=O)- [aromatic attach]",
			...
			// misc halogen
			"-CF3 [aliphatic attach]", "-CF3 [aromatic attach]", "-CCl3 [aromatic attach]", "-CCl3 [aliphatic attach]",
			"Halogen [Nitrogen attach]",

			// misc
			"As(=O)", "-N=C=S", "Sn=O", "-N=S=O" };
...
//	public double nvx;    // Number of Graph Vertices (number of nonhydrogen atoms)
	...
	public double BEHv1; // highest eigenvalue n. 1 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BEHv2; // highest eigenvalue n. 2 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BEHv3; // highest eigenvalue n. 3 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BEHv4; // highest eigenvalue n. 4 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BEHv5; // highest eigenvalue n. 5 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BEHv6; // highest eigenvalue n. 6 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BEHv7; // highest eigenvalue n. 7 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BEHv8; // highest eigenvalue n. 8 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BELv1; // lowest eigenvalue n. 1 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BELv2; // lowest eigenvalue n. 2 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BELv3; // lowest eigenvalue n. 3 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BELv4; // lowest eigenvalue n. 4 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BELv5; // lowest eigenvalue n. 5 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BELv6; // lowest eigenvalue n. 6 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BELv7; // lowest eigenvalue n. 7 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BELv8; // lowest eigenvalue n. 8 of Burden matrix / weighted by atomic van der Waals
							// volumes
	public double BEHe1; // highest eigenvalue n. 1 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BEHe2; // highest eigenvalue n. 2 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BEHe3; // highest eigenvalue n. 3 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BEHe4; // highest eigenvalue n. 4 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BEHe5; // highest eigenvalue n. 5 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BEHe6; // highest eigenvalue n. 6 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BEHe7; // highest eigenvalue n. 7 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BEHe8; // highest eigenvalue n. 8 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BELe1; // lowest eigenvalue n. 1 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BELe2; // lowest eigenvalue n. 2 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BELe3; // lowest eigenvalue n. 3 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BELe4; // lowest eigenvalue n. 4 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BELe5; // lowest eigenvalue n. 5 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BELe6; // lowest eigenvalue n. 6 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BELe7; // lowest eigenvalue n. 7 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BELe8; // lowest eigenvalue n. 8 of Burden matrix / weighted by atomic Sanderson
							// electronegativities
	public double BEHp1; // highest eigenvalue n. 1 of Burden matrix / weighted by atomic
							// polarizabilities
	public double BEHp2; // highest eigenvalue n. 2 of Burden matrix / weighted by atomic
							// polarizabilities
	public double BEHp3; // highest eigenvalue n. 3 of Burden matrix / weighted by atomic
							// polarizabilities
	public double BEHp4; // highest eigenvalue n. 4 of Burden matrix / weighted by atomic
							// polarizabilities
	public double BEHp5; // highest eigenvalue n. 5 of Burden matrix / weighted by atomic
							// polarizabilities
	public double BEHp6; // highest eigenvalue n. 6 of Burden matrix / weighted by atomic
							// polarizabilities
	public double BEHp7; // highest eigenvalue n. 7 of Burden matrix / weighted by atomic
							// polarizabilities
	public double BEHp8; // highest eigenvalue n. 8 of Burden matrix / weighted by atomic
							// polarizabilities
	...
	public double piPC01; // molecular multiple path count of order 01 (sum of conventional bond orders,
							// SCBO)
	...
	public double ATS1m; // Broto-Moreau autocorrelation of a topological structure - lag 1 / weighted by
							// atomic masses
	public double ATS2m; // Broto-Moreau autocorrelation of a topological structure - lag 2 / weighted by
							// atomic masses
	public double ATS3m; // Broto-Moreau autocorrelation of a topological structure - lag 3 / weighted by
							// atomic masses
	public double ATS4m; // Broto-Moreau autocorrelation of a topological structure - lag 4 / weighted by
							// atomic masses
	public double ATS5m; // Broto-Moreau autocorrelation of a topological structure - lag 5 / weighted by
							// atomic masses
	public double ATS6m; // Broto-Moreau autocorrelation of a topological structure - lag 6 / weighted by
							// atomic masses
	public double ATS7m; // Broto-Moreau autocorrelation of a topological structure - lag 7 / weighted by
							// atomic masses
	public double ATS8m; // Broto-Moreau autocorrelation of a topological structure - lag 8 / weighted by
							// atomic masses
	public double ATS1v; // Broto-Moreau autocorrelation of a topological structure - lag 1 / weighted by
							// atomic van der Waals volumes
	public double ATS2v; // Broto-Moreau autocorrelation of a topological structure - lag 2 / weighted by
							// atomic van der Waals volumes
	public double ATS3v; // Broto-Moreau autocorrelation of a topological structure - lag 3 / weighted by
							// atomic van der Waals volumes
	public double ATS4v; // Broto-Moreau autocorrelation of a topological structure - lag 4 / weighted by
							// atomic van der Waals volumes
	public double ATS5v; // Broto-Moreau autocorrelation of a topological structure - lag 5 / weighted by
							// atomic van der Waals volumes
	public double ATS6v; // Broto-Moreau autocorrelation of a topological structure - lag 6 / weighted by
							// atomic van der Waals volumes
	public double ATS7v; // Broto-Moreau autocorrelation of a topological structure - lag 7 / weighted by
							// atomic van der Waals volumes
	public double ATS8v; // Broto-Moreau autocorrelation of a topological structure - lag 8 / weighted by
							// atomic van der Waals volumes
	public double ATS1e; // Broto-Moreau autocorrelation of a topological structure - lag 1 / weighted by
							// atomic Sanderson electronegativities
	public double ATS2e; // Broto-Moreau autocorrelation of a topological structure - lag 2 / weighted by
							// atomic Sanderson electronegativities
	public double ATS3e; // Broto-Moreau autocorrelation of a topological structure - lag 3 / weighted by
							// atomic Sanderson electronegativities
	public double ATS4e; // Broto-Moreau autocorrelation of a topological structure - lag 4 / weighted by
							// atomic Sanderson electronegativities
	public double ATS5e; // Broto-Moreau autocorrelation of a topological structure - lag 5 / weighted by
							// atomic Sanderson electronegativities
	public double ATS6e; // Broto-Moreau autocorrelation of a topological structure - lag 6 / weighted by
							// atomic Sanderson electronegativities
	public double ATS7e; // Broto-Moreau autocorrelation of a topological structure - lag 7 / weighted by
							// atomic Sanderson electronegativities
	public double ATS8e; // Broto-Moreau autocorrelation of a topological structure - lag 8 / weighted by
							// atomic Sanderson electronegativities
	public double ATS1p; // Broto-Moreau autocorrelation of a topological structure - lag 1 / weighted by
							// atomic polarizabilities
	public double ATS2p; // Broto-Moreau autocorrelation of a topological structure - lag 2 / weighted by
							// atomic polarizabilities
	public double ATS3p; // Broto-Moreau autocorrelation of a topological structure - lag 3 / weighted by
							// atomic polarizabilities
	public double ATS4p; // Broto-Moreau autocorrelation of a topological structure - lag 4 / weighted by
							// atomic polarizabilities
	public double ATS5p; // Broto-Moreau autocorrelation of a topological structure - lag 5 / weighted by
							// atomic polarizabilities
	public double ATS6p; // Broto-Moreau autocorrelation of a topological structure - lag 6 / weighted by
							// atomic polarizabilities
	public double ATS7p; // Broto-Moreau autocorrelation of a topological structure - lag 7 / weighted by
							// atomic polarizabilities
	public double ATS8p; // Broto-Moreau autocorrelation of a topological structure - lag 8 / weighted by
							// atomic polarizabilities
	...
	public double MATS1e; // Moran autocorrelation - lag 1 / weighted by atomic Sanderson
							// electronegativities
	public double MATS2e; // Moran autocorrelation - lag 2 / weighted by atomic Sanderson
							// electronegativities
	public double MATS3e; // Moran autocorrelation - lag 3 / weighted by atomic Sanderson
							// electronegativities
	public double MATS4e; // Moran autocorrelation - lag 4 / weighted by atomic Sanderson
							// electronegativities
	public double MATS5e; // Moran autocorrelation - lag 5 / weighted by atomic Sanderson
							// electronegativities
	public double MATS6e; // Moran autocorrelation - lag 6 / weighted by atomic Sanderson
							// electronegativities
	public double MATS7e; // Moran autocorrelation - lag 7 / weighted by atomic Sanderson
							// electronegativities
	public double MATS8e; // Moran autocorrelation - lag 8 / weighted by atomic Sanderson
							// electronegativities
	...
	public double GATS1e; // Geary autocorrelation - lag 1 / weighted by atomic Sanderson
							// electronegativities
	public double GATS2e; // Geary autocorrelation - lag 2 / weighted by atomic Sanderson
							// electronegativities
	public double GATS3e; // Geary autocorrelation - lag 3 / weighted by atomic Sanderson
							// electronegativities
	public double GATS4e; // Geary autocorrelation - lag 4 / weighted by atomic Sanderson
							// electronegativities
	public double GATS5e; // Geary autocorrelation - lag 5 / weighted by atomic Sanderson
							// electronegativities
	public double GATS6e; // Geary autocorrelation - lag 6 / weighted by atomic Sanderson
							// electronegativities
	public double GATS7e; // Geary autocorrelation - lag 7 / weighted by atomic Sanderson
							// electronegativities
	public double GATS8e; // Geary autocorrelation - lag 8 / weighted by atomic Sanderson
							// electronegativities
...
// *****************************************************************************
	...
	// A. General (8)
	/*
	 * public double Volume ; // Volume public double SA; // Surface area public
	 * double Ovality; // Ovality public double Dipole; // Dipole public double
	 * Polar; // Polarizability public double SpcPolar; // Molar or specific
	 * polarizability public double HOMO; // Energy of the highest occupied
	 * molecular orbital public double LUMO; // Energy of the lowest unoccupied
	 * molecular orbital
	 * 
	 * //B. Charge Descriptors (18) public double qpmax; // Maximum positive charge
	 * on any atom public double qnmax; // Maximum negative charge on any atom
	 * public double Qpos; // Total positive charge public double Qneg; // Total
	 * negative charge public double Qtot; // Sum of absolute charges of all atoms
	 * public double Qmean; // Charge polarization or mean absolute charge public
	 * double Q2; // Total squared atomic charge public double SPP; // Submolecular
	 * polarity parameter public double TE1; // Topological electronic descriptor
	 * public double TE2; // Topological electronic descriptor (bond restricted)
	 * public double PCWTe; // Partial charge weighted topological electronic
	 * descriptor public double LDI; // Local dipole index public double et0; // 0th
	 * order electronic topological index, 0ET public double et1; // 1st order
	 * electronic topological index, 1ET public double et2; // 2nd order electronic
	 * topological index, 2ET public double et3; // 3rd order electronic topological
	 * index, 3ET public double MaxHp; // Maximum positive charge on Hydrogen atom
	 * public double ABSQon; // Sum of absolute charges of all Oxygen and Nitrogen
	 * atoms
	 */
	// ********************************************************************************
	// XIV. Principal moment of inertia (7) (see DMOMI in ADAPT, see pg 352 and 405
	// Todeschini book
...
//	 ***********************************************************************
	...
	public double E1m; // 1st component accessibility directional WHIM index / weighted by atomic
						// masses
	public double E2m; // 2nd component accessibility directional WHIM index / weighted by atomic
						// masses
	public double E3m; // 3rd component accessibility directional WHIM index / weighted by atomic
						// masses
	public double L1v; // 1st component size directional WHIM index / weighted by atomic van der Waals
						// volumes
	public double L2v; // 2nd component size directional WHIM index / weighted by atomic van der Waals
						// volumes
	public double L3v; // 3rd component size directional WHIM index / weighted by atomic van der Waals
						// volumes
	public double P1v; // 1st component shape directional WHIM index / weighted by atomic van der Waals
						// volumes
	public double P2v; // 2nd component shape directional WHIM index / weighted by atomic van der Waals
						// volumes
	public double G1v; // 1st component symmetry directional WHIM index / weighted by atomic van der
						// Waals volumes
	public double G2v; // 2st component symmetry directional WHIM index / weighted by atomic van der
						// Waals volumes
	public double G3v; // 3st component symmetry directional WHIM index / weighted by atomic van der
						// Waals volumes
	public double E1v; // 1st component accessibility directional WHIM index / weighted by atomic van
						// der Waals volumes
	public double E2v; // 2nd component accessibility directional WHIM index / weighted by atomic van
						// der Waals volumes
	public double E3v; // 3rd component accessibility directional WHIM index / weighted by atomic van
						// der Waals volumes
	public double L1e; // 1st component size directional WHIM index / weighted by atomic Sanderson
						// electronegativities
	public double L2e; // 2nd component size directional WHIM index / weighted by atomic Sanderson
						// electronegativities
	public double L3e; // 3rd component size directional WHIM index / weighted by atomic Sanderson
						// electronegativities
	public double P1e; // 1st component shape directional WHIM index / weighted by atomic Sanderson
						// electronegativities
	public double P2e; // 2nd component shape directional WHIM index / weighted by atomic Sanderson
						// electronegativities
	public double G1e; // 1st component symmetry directional WHIM index / weighted by atomic Sanderson
						// electronegativities
	public double G2e; // 2st component symmetry directional WHIM index / weighted by atomic Sanderson
						// electronegativities
	public double G3e; // 3st component symmetry directional WHIM index / weighted by atomic Sanderson
						// electronegativities
	public double E1e; // 1st component accessibility directional WHIM index / weighted by atomic
						// Sanderson electronegativities
	public double E2e; // 2nd component accessibility directional WHIM index / weighted by atomic
						// Sanderson electronegativities
	public double E3e; // 3rd component accessibility directional WHIM index / weighted by atomic
						// Sanderson electronegativities
	public double L1p; // 1st component size directional WHIM index / weighted by atomic
						// polarizabilities
	public double L2p; // 2nd component size directional WHIM index / weighted by atomic
						// polarizabilities
	public double L3p; // 3rd component size directional WHIM index / weighted by atomic
						// polarizabilities
	public double P1p; // 1st component shape directional WHIM index / weighted by atomic
						// polarizabilities
	public double P2p; // 2nd component shape directional WHIM index / weighted by atomic
						// polarizabilities
	public double G1p; // 1st component symmetry directional WHIM index / weighted by atomic
						// polarizabilities
	public double G2p; // 2st component symmetry directional WHIM index / weighted by atomic
						// polarizabilities
	public double G3p; // 3st component symmetry directional WHIM index / weighted by atomic
						// polarizabilities
	public double E1p; // 1st component accessibility directional WHIM index / weighted by atomic
						// polarizabilities
	public double E2p; // 2nd component accessibility directional WHIM index / weighted by atomic
						// polarizabilities
	public double E3p; // 3rd component accessibility directional WHIM index / weighted by atomic
						// polarizabilities
	public double L1s; // 1st component size directional WHIM index / weighted by atomic
						// electrotopological states
	public double L2s; // 2nd component size directional WHIM index / weighted by atomic
						// electrotopological states
	public double L3s; // 3rd component size directional WHIM index / weighted by atomic
						// electrotopological states
	public double P1s; // 1st component shape directional WHIM index / weighted by atomic
						// electrotopological states
	public double P2s; // 2nd component shape directional WHIM index / weighted by atomic
						// electrotopological states
	public double G1s; // 1st component symmetry directional WHIM index / weighted by atomic
						// electrotopological states
	public double G2s; // 2st component symmetry directional WHIM index / weighted by atomic
						// electrotopological states
	public double G3s; // 3st component symmetry directional WHIM index / weighted by atomic
						// electrotopological states
	public double E1s; // 1st component accessibility directional WHIM index / weighted by atomic
						// electrotopological states
	public double E2s; // 2nd component accessibility directional WHIM index / weighted by atomic
						// electrotopological states
	public double E3s; // 3rd component accessibility directional WHIM index / weighted by atomic
						// electrotopological states
	...
	public double De; // D total accessibility index / weighted by atomic Sanderson
						// electronegativities
...
//	 ***********************************************************************
	...
	public double HATS0v; // leverage-weighted autocorrelation of lag 0 / weighted by atomic van der Waals
							// volumes
	public double HATS1v; // leverage-weighted autocorrelation of lag 1 / weighted by atomic van der Waals
							// volumes
	public double HATS2v; // leverage-weighted autocorrelation of lag 2 / weighted by atomic van der Waals
							// volumes
	public double HATS3v; // leverage-weighted autocorrelation of lag 3 / weighted by atomic van der Waals
							// volumes
	public double HATS4v; // leverage-weighted autocorrelation of lag 4 / weighted by atomic van der Waals
							// volumes
	public double HATS5v; // leverage-weighted autocorrelation of lag 5 / weighted by atomic van der Waals
							// volumes
	public double HATS6v; // leverage-weighted autocorrelation of lag 6 / weighted by atomic van der Waals
							// volumes
	public double HATS7v; // leverage-weighted autocorrelation of lag 7 / weighted by atomic van der Waals
							// volumes
	public double HATS8v; // leverage-weighted autocorrelation of lag 8 / weighted by atomic van der Waals
							// volumes
	...
	public double HATS0e; // leverage-weighted autocorrelation of lag 0 / weighted by atomic Sanderson
							// electronegativities
	public double HATS1e; // leverage-weighted autocorrelation of lag 1 / weighted by atomic Sanderson
							// electronegativities
	public double HATS2e; // leverage-weighted autocorrelation of lag 2 / weighted by atomic Sanderson
							// electronegativities
	public double HATS3e; // leverage-weighted autocorrelation of lag 3 / weighted by atomic Sanderson
							// electronegativities
	public double HATS4e; // leverage-weighted autocorrelation of lag 4 / weighted by atomic Sanderson
							// electronegativities
	public double HATS5e; // leverage-weighted autocorrelation of lag 5 / weighted by atomic Sanderson
							// electronegativities
	public double HATS6e; // leverage-weighted autocorrelation of lag 6 / weighted by atomic Sanderson
							// electronegativities
	public double HATS7e; // leverage-weighted autocorrelation of lag 7 / weighted by atomic Sanderson
							// electronegativities
	public double HATS8e; // leverage-weighted autocorrelation of lag 8 / weighted by atomic Sanderson
							// electronegativities
	public double HATSe; // leverage-weighted total index / weighted by atomic Sanderson
							// electronegativities
	...
	public double HATS0p; // leverage-weighted autocorrelation of lag 0 / weighted by atomic
							// polarizabilities
	public double HATS1p; // leverage-weighted autocorrelation of lag 1 / weighted by atomic
							// polarizabilities
	public double HATS2p; // leverage-weighted autocorrelation of lag 2 / weighted by atomic
							// polarizabilities
	public double HATS3p; // leverage-weighted autocorrelation of lag 3 / weighted by atomic
							// polarizabilities
	public double HATS4p; // leverage-weighted autocorrelation of lag 4 / weighted by atomic
							// polarizabilities
	public double HATS5p; // leverage-weighted autocorrelation of lag 5 / weighted by atomic
							// polarizabilities
	public double HATS6p; // leverage-weighted autocorrelation of lag 6 / weighted by atomic
							// polarizabilities
	public double HATS7p; // leverage-weighted autocorrelation of lag 7 / weighted by atomic
							// polarizabilities
	public double HATS8p; // leverage-weighted autocorrelation of lag 8 / weighted by atomic
							// polarizabilities
	...
	public double R1eplus;// R maximal autocorrelation of lag 1 / weighted by atomic Sanderson
							// electronegativities
	public double R2eplus;// R maximal autocorrelation of lag 2 / weighted by atomic Sanderson
							// electronegativities
	public double R3eplus;// R maximal autocorrelation of lag 3 / weighted by atomic Sanderson
							// electronegativities
	public double R4eplus;// R maximal autocorrelation of lag 4 / weighted by atomic Sanderson
							// electronegativities
	public double R5eplus;// R maximal autocorrelation of lag 5 / weighted by atomic Sanderson
							// electronegativities
	public double R6eplus;// R maximal autocorrelation of lag 6 / weighted by atomic Sanderson
							// electronegativities
	public double R7eplus;// R maximal autocorrelation of lag 7 / weighted by atomic Sanderson
							// electronegativities
	public double R8eplus;// R maximal autocorrelation of lag 8 / weighted by atomic Sanderson
							// electronegativities
	...
	// electron-neutron attraction, electron-electron repulsion and atomic state
	// energy for atoms
	...
	public double fhbca; // Charged surface areas of both hydrogen bond acceptors and donors relative to
							// TMSA
	...
	public double hrpcs; // Relative positive charge surface area (RPCS) restricted to hydrogen bond
							// donors
	public double hrncs; // Relative negative charge surface area (RNCS) restricted to hydrogen bond
							// acceptors
...
//	public double mw;			//Molecular weight
	...
	public String[] varlist2d = { "strChi", "strKappa", "strES", "strES_acnt", "strHES", "strESMaxMin", "str2D",
			"strIC", "strMDEC", "strBurden", "strTopo", "strCon", "str2DAuto", "strWalk", "strMP" }; // array of list
																										// names
...
//	String[] varlist3d = {"strWHIM","strGetaway","strMOMI","strRandicShape", "strQM"};
	...
	public String[] strxp = { "x0", "x1", "x2", "xp3", "xp4", "xp5", "xp6", "xp7", "xp8", "xp9", "xp10" };

	public String[] strxvp = { "xv0", "xv1", "xv2", "xvp3", "xvp4", "xvp5", "xvp6", "xvp7", "xvp8", "xvp9", "xvp10" };

	public String[] strChi = { "x0", "x1", "x2", "xp3", "xp4", "xp5", "xp6", "xp7", "xp8", "xp9", "xp10", "xc3", "xc4",
			"xpc4", "xch3", "xch4", "xch5", "xch6", "xch7", "xch8", "xch9", "xch10", "knotp", "xv0", "xv1", "xv2",
			"xvp3", "xvp4", "xvp5", "xvp6", "xvp7", "xvp8", "xvp9", "xvp10", "xvc3", "xvc4", "xvpc4", "xvch3", "xvch4",
...
//	public String [] strKappa={"k0", "k1", "k2", "k3","ka0", "ka1", "ka2", "ka3","phia"};
	...
	public String[] strES = { "SsCH3", "SdCH2", "SssCH2", "StCH", "SdsCH", "SaaCH", "SsssCH", "SddC", "StsC", "SdssC",
			"SsaaC", "SaaaC", "SssssC", "SsNH2", "SdNH", "SssNH", "SaaNH", "StN", "SdsN", "SaaN", "SsssN", "SaaaN",
			"SsaaN", "SsNH3p", "SssNH2p", "SsssNHp", "SddNp", "StsNp", "SdNm", "SdssNp", "SssssNp", "SsaaNp", "SsOH",
			"SdO", "SssO", "SaaO", "SsOm", "SsF", "SsCl", "SsBr", "SsI", "SsSiH3", "SssSiH2", "SsssSiH", "SssssSi",
			"SsssP", "SdsssP", "SddsP", "SsssssP", "SdssPH", "SsPH2", "SssPH", "SsSH", "SdS", "SssS", "SaaS", "SdssS",
			"SddssS", "SssssssS", "SsSnH3", "SssSnH2", "SsssSnH", "SssssSn", "SsPbH3", "SssPbH2", "SsssPbH", "SssssPb",
			"SsssAs", "SdsssAs", "SddsAs", "SsssssAs", "SsAsH2", "SssAsH", "SsHgp", "SssHg", "SsHg", "StCm" };
...
//	public String[] strES_acnt={"SsCH3_acnt","SdCH2_acnt","SssCH2_acnt","StCH_acnt","SdsCH_acnt","SaaCH_acnt","SsssCH_acnt","SddC_acnt","StsC_acnt","SdssC_acnt","SsaaC_acnt","SaaaC_acnt","SssssC_acnt","SsNH2_acnt","SdNH_acnt","SssNH_acnt","SaaNH_acnt","StN_acnt","SdsN_acnt","SaaN_acnt","SsssN_acnt","SaaaN_acnt","SsaaN_acnt","SsNH3p_acnt","SssNH2p_acnt","SsssNHp_acnt","SddNp_acnt","StsNp_acnt","SdNm_acnt","SdssNp_acnt","SssssNp_acnt","SsaaNp_acnt","SsOH_acnt","SdO_acnt","SssO_acnt","SaaO_acnt","SsOm_acnt","SsF_acnt","SsCl_acnt","SsBr_acnt","SsI_acnt","SsSiH3_acnt","SssSiH2_acnt","SsssSiH_acnt","SssssSi_acnt","SsssP_acnt","SdsssP_acnt","SddsP_acnt","SsssssP_acnt","SdssPH_acnt","SsPH2_acnt","SssPH_acnt","SsSH_acnt","SdS_acnt","SssS_acnt","SaaS_acnt","SdssS_acnt","SddssS_acnt","SssssssS_acnt","SsSnH3_acnt","SssSnH2_acnt","SsssSnH_acnt","SssssSn_acnt","SsPbH3_acnt","SssPbH2_acnt","SsssPbH_acnt","SssssPb_acnt","SsssAs_acnt","SdsssAs_acnt","SddsAs_acnt","SsssssAs_acnt","SsAsH2_acnt","SssAsH_acnt","SsHgp_acnt","SssHg_acnt","SsHg_acnt","StCm_acnt"};
	...
	public String[] strHES = { "SHsOH", "SHother", "SHdNH", "SHsSH", "SHsNH2", "SHssNH", "SHtCH", "SHCHnX" };

	public String[] strESMaxMin = { "Hmax", "Gmax", "Hmin", "Gmin", "Hmaxpos", "Hminneg" };

	public String[] str2D = { "numHBa", "numHBd", "numwHBd", "SHHBa", "SHHBd", "SHwHBd", "Qs", "Qv", "Qsv" };

	public String[] strIC = { "ic", "si", "ib", "I", "maxic", "ssi", "R", "eim", "iadje", "iadjem", "iadjm", "iadjmm",
			"ivdem", "ivdmm", "ieadje", "ieadjem", "ieadjm", "ieadjmm", "ide", "idem", "idm", "idmm", "iddem", "iddmm",
			"iede", "iedem", "We", "iedm", "iedmm", "tvc", "icyce", "icycem", "icycm", "icycmm", "tti", "ttvi" };
	public String[] strMP = { "XLOGP", "XLOGP2", "ALOGP", "ALOGP2", "AMR", "Hy", "Ui" };

	public String[] strMDEC = { "MDEC11", "MDEC12", "MDEC13", "MDEC14", "MDEC22", "MDEC23", "MDEC24", "MDEC33",
			"MDEC34", "MDEC44", "MDEO11", "MDEO12", "MDEO22", "MDEN11", "MDEN12", "MDEN13", "MDEN22", "MDEN23",
			"MDEN33" };

	public String[] strBurden = { "BEHm1", "BEHm2", "BEHm3", "BEHm4", "BEHm5", "BEHm6", "BEHm7", "BEHm8", "BELm1",
			"BELm2", "BELm3", "BELm4", "BELm5", "BELm6", "BELm7", "BELm8", "BEHv1", "BEHv2", "BEHv3", "BEHv4", "BEHv5",
			"BEHv6", "BEHv7", "BEHv8", "BELv1", "BELv2", "BELv3", "BELv4", "BELv5", "BELv6", "BELv7", "BELv8", "BEHe1",
			"BEHe2", "BEHe3", "BEHe4", "BEHe5", "BEHe6", "BEHe7", "BEHe8", "BELe1", "BELe2", "BELe3", "BELe4", "BELe5",
			"BELe6", "BELe7", "BELe8", "BEHp1", "BEHp2", "BEHp3", "BEHp4", "BEHp5", "BEHp6", "BEHp7", "BEHp8", "BELp1",
			"BELp2", "BELp3", "BELp4", "BELp5", "BELp6", "BELp7", "BELp8" };

	public String[] strGetaway = { "HGM", "ITH", "ISH", "HIC", "H0u", "H1u", "H2u", "H3u", "H4u", "H5u", "H6u", "H7u",
			"H8u", "HTu", "HATS0u", "HATS1u", "HATS2u", "HATS3u", "HATS4u", "HATS5u", "HATS6u", "HATS7u", "HATS8u",
			"HATSu", "H0m", "H1m", "H2m", "H3m", "H4m", "H5m", "H6m", "H7m", "H8m", "HTm", "HATS0m", "HATS1m", "HATS2m",
			"HATS3m", "HATS4m", "HATS5m", "HATS6m", "HATS7m", "HATS8m", "HATSm", "H0v", "H1v", "H2v", "H3v", "H4v",
			"H5v", "H6v", "H7v", "H8v", "HTv", "HATS0v", "HATS1v", "HATS2v", "HATS3v", "HATS4v", "HATS5v", "HATS6v",
			"HATS7v", "HATS8v", "HATSv", "H0e", "H1e", "H2e", "H3e", "H4e", "H5e", "H6e", "H7e", "H8e", "HTe", "HATS0e",
			"HATS1e", "HATS2e", "HATS3e", "HATS4e", "HATS5e", "HATS6e", "HATS7e", "HATS8e", "HATSe", "H0p", "H1p",
			"H2p", "H3p", "H4p", "H5p", "H6p", "H7p", "H8p", "HTp", "HATS0p", "HATS1p", "HATS2p", "HATS3p", "HATS4p",
			"HATS5p", "HATS6p", "HATS7p", "HATS8p", "HATSp", "RCON", "RARS", "REIG", "R1u", "R2u", "R3u", "R4u", "R5u",
			"R6u", "R7u", "R8u", "RTu", "R1uplus", "R2uplus", "R3uplus", "R4uplus", "R5uplus", "R6uplus", "R7uplus",
			"R8uplus", "RTuplus", "R1m", "R2m", "R3m", "R4m", "R5m", "R6m", "R7m", "R8m", "RTm", "R1mplus", "R2mplus",
			"R3mplus", "R4mplus", "R5mplus", "R6mplus", "R7mplus", "R8mplus", "RTmplus", "R1v", "R2v", "R3v", "R4v",
			"R5v", "R6v", "R7v", "R8v", "RTv", "R1vplus", "R2vplus", "R3vplus", "R4vplus", "R5vplus", "R6vplus",
			"R7vplus", "R8vplus", "RTvplus", "R1e", "R2e", "R3e", "R4e", "R5e", "R6e", "R7e", "R8e", "RTe", "R1eplus",
			"R2eplus", "R3eplus", "R4eplus", "R5eplus", "R6eplus", "R7eplus", "R8eplus", "RTeplus", "R1p", "R2p", "R3p",
			"R4p", "R5p", "R6p", "R7p", "R8p", "RTp", "R1pplus", "R2pplus", "R3pplus", "R4pplus", "R5pplus", "R6pplus",
			"R7pplus", "R8pplus", "RTpplus" };

	public String[] strTopo = { "ZM1", "ZM1V", "ZM2", "ZM2V", "J", "Jt", "BAC", "Lop", "ICR", "TIE", "MAXDN", "MAXDP",
			"DELS", "W", "WA" };

	public String[] str2DAuto = { "ATS1m", "ATS2m", "ATS3m", "ATS4m", "ATS5m", "ATS6m", "ATS7m", "ATS8m", "ATS1v",
			"ATS2v", "ATS3v", "ATS4v", "ATS5v", "ATS6v", "ATS7v", "ATS8v", "ATS1e", "ATS2e", "ATS3e", "ATS4e", "ATS5e",
			"ATS6e", "ATS7e", "ATS8e", "ATS1p", "ATS2p", "ATS3p", "ATS4p", "ATS5p", "ATS6p", "ATS7p", "ATS8p", "MATS1m",
			"MATS2m", "MATS3m", "MATS4m", "MATS5m", "MATS6m", "MATS7m", "MATS8m", "MATS1v", "MATS2v", "MATS3v",
			"MATS4v", "MATS5v", "MATS6v", "MATS7v", "MATS8v", "MATS1e", "MATS2e", "MATS3e", "MATS4e", "MATS5e",
			"MATS6e", "MATS7e", "MATS8e", "MATS1p", "MATS2p", "MATS3p", "MATS4p", "MATS5p", "MATS6p", "MATS7p",
			"MATS8p", "GATS1m", "GATS2m", "GATS3m", "GATS4m", "GATS5m", "GATS6m", "GATS7m", "GATS8m", "GATS1v",
			"GATS2v", "GATS3v", "GATS4v", "GATS5v", "GATS6v", "GATS7v", "GATS8v", "GATS1e", "GATS2e", "GATS3e",
			"GATS4e", "GATS5e", "GATS6e", "GATS7e", "GATS8e", "GATS1p", "GATS2p", "GATS3p", "GATS4p", "GATS5p",
			"GATS6p", "GATS7p", "GATS8p" };

	public String[] strCon = { "MW", "AMW", "Sv", "Se", "Sp", "Ss", "Mv", "Me", "Mp", "Ms", "nAT", "nSK", "nBT", "nBO",
			"nBM", "SCBO", "ARR", "nCIC", "nCIR", "nDB", "nTB", "nAB", "nH", "nC", "nN", "nO", "nP", "nS", "nF", "nCL",
			"nBR", "nI", "nB", "nX", "nR03", "nR04", "nR05", "nR06", "nR07", "nR08", "nR09", "nR10", "nR11", "nR12",
			"nBnz" };

	public String[] strWHIM = { "L1u", "L2u", "L3u", "P1u", "P2u", "G1u", "G2u", "G3u", "E1u", "E2u", "E3u", "L1m",
			"L2m", "L3m", "P1m", "P2m", "G1m", "G2m", "G3m", "E1m", "E2m", "E3m", "L1v", "L2v", "L3v", "P1v", "P2v",
			"G1v", "G2v", "G3v", "E1v", "E2v", "E3v", "L1e", "L2e", "L3e", "P1e", "P2e", "G1e", "G2e", "G3e", "E1e",
			"E2e", "E3e", "L1p", "L2p", "L3p", "P1p", "P2p", "G1p", "G2p", "G3p", "E1p", "E2p", "E3p", "L1s", "L2s",
			"L3s", "P1s", "P2s", "G1s", "G2s", "G3s", "E1s", "E2s", "E3s", "Tu", "Tm", "Tv", "Te", "Tp", "Ts", "Au",
			"Am", "Av", "Ae", "Ap", "As", "Vu", "Vm", "Vv", "Ve", "Vp", "Vs", "Gu", "Gm", "Gs", "Ku", "Km", "Kv", "Ke",
			"Kp", "Ks", "Du", "Dm", "Dv", "De", "Dp", "Ds" };

	public String[] strWalk = { "MWC01", "MWC02", "MWC03", "MWC04", "MWC05", "MWC06", "MWC07", "MWC08", "MWC09",
			"MWC10", "SRW01", "SRW02", "SRW03", "SRW04", "SRW05", "SRW06", "SRW07", "SRW08", "SRW09", "SRW10", "MPC01",
			"MPC02", "MPC03", "MPC04", "MPC05", "MPC06", "MPC07", "MPC08", "MPC09", "MPC10", "piPC01", "piPC02",
			"piPC03", "piPC04", "piPC05", "piPC06", "piPC07", "piPC08", "piPC09", "piPC10", "piID", "TWC", "TPC", "CID",
			"CID2", "BID" };

	public String[] strMOMI = { "MOMI1", "MOMI2", "MOMI3", "MOMI4", "MOMI5", "MOMI6", "MOMI7" };

	public String[] strRandicShape = { "DP01", "DP02", "DP03", "DP04", "DP05", "DP06", "DP07", "DP08", "DP09", "DP10",
			"DP11", "DP12", "DP13", "DP14", "DP15", "DP16", "DP17", "DP18", "DP19", "DP20", "SP01", "SP02", "SP03",
			"SP04", "SP05", "SP06", "SP07", "SP08", "SP09", "SP10", "SP11", "SP12", "SP13", "SP14", "SP15", "SP16",
			"SP17", "SP18", "SP19", "SP20", "SHP2" };

	public String[] strQM = { "qpmax", "qnmax", "Qpos", "Qneg", "Qtot", "Qmean", "Q2", "SPP", "SPP2", "Pprime", "DP",
			"TE1", "TE2", "PCWTE", "LDI", "ET0", "ET1", "ET2", "ET3", "MaxPC_C", "MinPC_C", "MaxPC_N", "MinPC_N",
			"MaxPC_P", "MinPC_P", "MaxPC_O", "MinPC_O", "MaxPC_S", "MinPC_S", "MaxPC_Si", "MinPC_Si", "MaxPC_Hg",
			"MinPC_Hg", "MaxPC_H", "MinPC_H", "MaxPC_F", "MinPC_F", "MaxPC_Cl", "MinPC_Cl", "MaxPC_Br", "MinPC_Br",
			"MaxPC_I", "MinPC_I", "Max_EFD_C", "Min_EFD_C", "Tot_EFD_C", "Av_EFD_C", "Max_EFD_N", "Min_EFD_N",
			"Tot_EFD_N", "Av_EFD_N", "Max_EFD_P", "Min_EFD_P", "Tot_EFD_P", "Av_EFD_P", "Max_EFD_O", "Min_EFD_O",
			"Tot_EFD_O", "Av_EFD_O", "Max_EFD_S", "Min_EFD_S", "Tot_EFD_S", "Av_EFD_S", "Max_EFD_Si", "Min_EFD_Si",
			"Tot_EFD_Si", "Av_EFD_Si", "Max_EFD_Hg", "Min_EFD_Hg", "Tot_EFD_Hg", "Av_EFD_Hg", "Max_EFD_H", "Min_EFD_H",
			"Tot_EFD_H", "Av_EFD_H", "Max_EFD_F", "Min_EFD_F", "Tot_EFD_F", "Av_EFD_F", "Max_EFD_Cl", "Min_EFD_Cl",
			"Tot_EFD_Cl", "Av_EFD_Cl", "Max_EFD_Br", "Min_EFD_Br", "Tot_EFD_Br", "Av_EFD_Br", "Max_EFD_I", "Min_EFD_I",
			"Tot_EFD_I", "Av_EFD_I", "Max_EFD", "Min_EFD", "Tot_EFD", "Av_EFD", "Max_NFD_C", "Min_NFD_C", "Tot_NFD_C",
			"Av_NFD_C", "Max_NFD_N", "Min_NFD_N", "Tot_NFD_N", "Av_NFD_N", "Max_NFD_P", "Min_NFD_P", "Tot_NFD_P",
			"Av_NFD_P", "Max_NFD_O", "Min_NFD_O", "Tot_NFD_O", "Av_NFD_O", "Max_NFD_S", "Min_NFD_S", "Tot_NFD_S",
			"Av_NFD_S", "Max_NFD_Si", "Min_NFD_Si", "Tot_NFD_Si", "Av_NFD_Si", "Max_NFD_Hg", "Min_NFD_Hg", "Tot_NFD_Hg",
			"Av_NFD_Hg", "Max_NFD_H", "Min_NFD_H", "Tot_NFD_H", "Av_NFD_H", "Max_NFD_F", "Min_NFD_F", "Tot_NFD_F",
			"Av_NFD_F", "Max_NFD_Cl", "Min_NFD_Cl", "Tot_NFD_Cl", "Av_NFD_Cl", "Max_NFD_Br", "Min_NFD_Br", "Tot_NFD_Br",
			"Av_NFD_Br", "Max_NFD_I", "Min_NFD_I", "Tot_NFD_I", "Av_NFD_I", "Max_NFD", "Min_NFD", "Tot_NFD", "Av_NFD",
			"Max_RFD_C", "Min_RFD_C", "Tot_RFD_C", "Av_RFD_C", "Max_RFD_N", "Min_RFD_N", "Tot_RFD_N", "Av_RFD_N",
			"Max_RFD_P", "Min_RFD_P", "Tot_RFD_P", "Av_RFD_P", "Max_RFD_O", "Min_RFD_O", "Tot_RFD_O", "Av_RFD_O",
			"Max_RFD_S", "Min_RFD_S", "Tot_RFD_S", "Av_RFD_S", "Max_RFD_Si", "Min_RFD_Si", "Tot_RFD_Si", "Av_RFD_Si",
			"Max_RFD_Hg", "Min_RFD_Hg", "Tot_RFD_Hg", "Av_RFD_Hg", "Max_RFD_H", "Min_RFD_H", "Tot_RFD_H", "Av_RFD_H",
			"Max_RFD_F", "Min_RFD_F", "Tot_RFD_F", "Av_RFD_F", "Max_RFD_Cl", "Min_RFD_Cl", "Tot_RFD_Cl", "Av_RFD_Cl",
			"Max_RFD_Br", "Min_RFD_Br", "Tot_RFD_Br", "Av_RFD_Br", "Max_RFD_I", "Min_RFD_I", "Tot_RFD_I", "Av_RFD_I",
			"Max_RFD", "Min_RFD", "Tot_RFD", "Av_RFD", "Max_EFDI_C", "Min_EFDI_C", "Tot_EFDI_C", "Av_EFDI_C",
			"Max_EFDI_N", "Min_EFDI_N", "Tot_EFDI_N", "Av_EFDI_N", "Max_EFDI_P", "Min_EFDI_P", "Tot_EFDI_P",
			"Av_EFDI_P", "Max_EFDI_O", "Min_EFDI_O", "Tot_EFDI_O", "Av_EFDI_O", "Max_EFDI_S", "Min_EFDI_S",
			"Tot_EFDI_S", "Av_EFDI_S", "Max_EFDI_Si", "Min_EFDI_Si", "Tot_EFDI_Si", "Av_EFDI_Si", "Max_EFDI_Hg",
			"Min_EFDI_Hg", "Tot_EFDI_Hg", "Av_EFDI_Hg", "Max_EFDI_H", "Min_EFDI_H", "Tot_EFDI_H", "Av_EFDI_H",
			"Max_EFDI_F", "Min_EFDI_F", "Tot_EFDI_F", "Av_EFDI_F", "Max_EFDI_Cl", "Min_EFDI_Cl", "Tot_EFDI_Cl",
			"Av_EFDI_Cl", "Max_EFDI_Br", "Min_EFDI_Br", "Tot_EFDI_Br", "Av_EFDI_Br", "Max_EFDI_I", "Min_EFDI_I",
			"Tot_EFDI_I", "Av_EFDI_I", "Max_EFDI", "Min_EFDI", "Tot_EFDI", "Av_EFDI", "Max_NFDI_C", "Min_NFDI_C",
			"Tot_NFDI_C", "Av_NFDI_C", "Max_NFDI_N", "Min_NFDI_N", "Tot_NFDI_N", "Av_NFDI_N", "Max_NFDI_P",
			"Min_NFDI_P", "Tot_NFDI_P", "Av_NFDI_P", "Max_NFDI_O", "Min_NFDI_O", "Tot_NFDI_O", "Av_NFDI_O",
			"Max_NFDI_S", "Min_NFDI_S", "Tot_NFDI_S", "Av_NFDI_S", "Max_NFDI_Si", "Min_NFDI_Si", "Tot_NFDI_Si",
			"Av_NFDI_Si", "Max_NFDI_Hg", "Min_NFDI_Hg", "Tot_NFDI_Hg", "Av_NFDI_Hg", "Max_NFDI_H", "Min_NFDI_H",
			"Tot_NFDI_H", "Av_NFDI_H", "Max_NFDI_F", "Min_NFDI_F", "Tot_NFDI_F", "Av_NFDI_F", "Max_NFDI_Cl",
			"Min_NFDI_Cl", "Tot_NFDI_Cl", "Av_NFDI_Cl", "Max_NFDI_Br", "Min_NFDI_Br", "Tot_NFDI_Br", "Av_NFDI_Br",
			"Max_NFDI_I", "Min_NFDI_I", "Tot_NFDI_I", "Av_NFDI_I", "Max_NFDI", "Min_NFDI", "Tot_NFDI", "Av_NFDI",
			"Max_RFDI_C", "Min_RFDI_C", "Tot_RFDI_C", "Av_RFDI_C", "Max_RFDI_N", "Min_RFDI_N", "Tot_RFDI_N",
			"Av_RFDI_N", "Max_RFDI_P", "Min_RFDI_P", "Tot_RFDI_P", "Av_RFDI_P", "Max_RFDI_O", "Min_RFDI_O",
			"Tot_RFDI_O", "Av_RFDI_O", "Max_RFDI_S", "Min_RFDI_S", "Tot_RFDI_S", "Av_RFDI_S", "Max_RFDI_Si",
			"Min_RFDI_Si", "Tot_RFDI_Si", "Av_RFDI_Si", "Max_RFDI_Hg", "Min_RFDI_Hg", "Tot_RFDI_Hg", "Av_RFDI_Hg",
			"Max_RFDI_H", "Min_RFDI_H", "Tot_RFDI_H", "Av_RFDI_H", "Max_RFDI_F", "Min_RFDI_F", "Tot_RFDI_F",
			"Av_RFDI_F", "Max_RFDI_Cl", "Min_RFDI_Cl", "Tot_RFDI_Cl", "Av_RFDI_Cl", "Max_RFDI_Br", "Min_RFDI_Br",
			"Tot_RFDI_Br", "Av_RFDI_Br", "Max_RFDI_I", "Min_RFDI_I", "Tot_RFDI_I", "Av_RFDI_I", "Max_RFDI", "Min_RFDI",
			"Tot_RFDI", "Av_RFDI", "Max_ESD_C", "Min_ESD_C", "Tot_ESD_C", "Av_ESD_C", "Max_ESD_N", "Min_ESD_N",
			"Tot_ESD_N", "Av_ESD_N", "Max_ESD_P", "Min_ESD_P", "Tot_ESD_P", "Av_ESD_P", "Max_ESD_O", "Min_ESD_O",
			"Tot_ESD_O", "Av_ESD_O", "Max_ESD_S", "Min_ESD_S", "Tot_ESD_S", "Av_ESD_S", "Max_ESD_Si", "Min_ESD_Si",
			"Tot_ESD_Si", "Av_ESD_Si", "Max_ESD_Hg", "Min_ESD_Hg", "Tot_ESD_Hg", "Av_ESD_Hg", "Max_ESD_H", "Min_ESD_H",
			"Tot_ESD_H", "Av_ESD_H", "Max_ESD_F", "Min_ESD_F", "Tot_ESD_F", "Av_ESD_F", "Max_ESD_Cl", "Min_ESD_Cl",
			"Tot_ESD_Cl", "Av_ESD_Cl", "Max_ESD_Br", "Min_ESD_Br", "Tot_ESD_Br", "Av_ESD_Br", "Max_ESD_I", "Min_ESD_I",
			"Tot_ESD_I", "Av_ESD_I", "Max_ESD", "Min_ESD", "Tot_ESD", "Av_ESD", "Max_NSD_C", "Min_NSD_C", "Tot_NSD_C",
			"Av_NSD_C", "Max_NSD_N", "Min_NSD_N", "Tot_NSD_N", "Av_NSD_N", "Max_NSD_P", "Min_NSD_P", "Tot_NSD_P",
			"Av_NSD_P", "Max_NSD_O", "Min_NSD_O", "Tot_NSD_O", "Av_NSD_O", "Max_NSD_S", "Min_NSD_S", "Tot_NSD_S",
			"Av_NSD_S", "Max_NSD_Si", "Min_NSD_Si", "Tot_NSD_Si", "Av_NSD_Si", "Max_NSD_Hg", "Min_NSD_Hg", "Tot_NSD_Hg",
			"Av_NSD_Hg", "Max_NSD_H", "Min_NSD_H", "Tot_NSD_H", "Av_NSD_H", "Max_NSD_F", "Min_NSD_F", "Tot_NSD_F",
			"Av_NSD_F", "Max_NSD_Cl", "Min_NSD_Cl", "Tot_NSD_Cl", "Av_NSD_Cl", "Max_NSD_Br", "Min_NSD_Br", "Tot_NSD_Br",
			"Av_NSD_Br", "Max_NSD_I", "Min_NSD_I", "Tot_NSD_I", "Av_NSD_I", "Max_NSD", "Min_NSD", "Tot_NSD", "Av_NSD",
			"Min_val_C", "Max_val_C", "Av_val_C", "Min_BO_C", "Max_BO_C", "Av_BO_C", "Min_val_N", "Max_val_N",
			"Av_val_N", "Min_BO_N", "Max_BO_N", "Av_BO_N", "Min_val_P", "Max_val_P", "Av_val_P", "Min_BO_P", "Max_BO_P",
			"Av_BO_P", "Min_val_O", "Max_val_O", "Av_val_O", "Min_BO_O", "Max_BO_O", "Av_BO_O", "Min_val_S",
			"Max_val_S", "Av_val_S", "Min_BO_S", "Max_BO_S", "Av_BO_S", "Min_val_Si", "Max_val_Si", "Av_val_Si",
			"Min_BO_Si", "Max_BO_Si", "Av_BO_Si", "Min_val_Hg", "Max_val_Hg", "Av_val_Hg", "Min_BO_Hg", "Max_BO_Hg",
			"Av_BO_Hg", "Min_val_H", "Max_val_H", "Av_val_H", "Min_BO_H", "Max_BO_H", "Av_BO_H", "Min_val_F",
			"Max_val_F", "Av_val_F", "Min_BO_F", "Max_BO_F", "Av_BO_F", "Min_val_Cl", "Max_val_Cl", "Av_val_Cl",
			"Min_BO_Cl", "Max_BO_Cl", "Av_BO_Cl", "Min_val_Br", "Max_val_Br", "Av_val_Br", "Min_BO_Br", "Max_BO_Br",
			"Av_BO_Br", "Min_val_I", "Max_val_I", "Av_val_I", "Min_BO_I", "Max_BO_I", "Av_BO_I", "Min_en_C", "Max_en_C",
			"Min_ee_C", "Max_ee_C", "Min_ase_C", "Max_ase_C", "Min_en_N", "Max_en_N", "Min_ee_N", "Max_ee_N",
			"Min_ase_N", "Max_ase_N", "Min_en_P", "Max_en_P", "Min_ee_P", "Max_ee_P", "Min_ase_P", "Max_ase_P",
			"Min_en_O", "Max_en_O", "Min_ee_O", "Max_ee_O", "Min_ase_O", "Max_ase_O", "Min_en_S", "Max_en_S",
			"Min_ee_S", "Max_ee_S", "Min_ase_S", "Max_ase_S", "Min_en_Si", "Max_en_Si", "Min_ee_Si", "Max_ee_Si",
			"Min_ase_Si", "Max_ase_Si", "Min_en_Hg", "Max_en_Hg", "Min_ee_Hg", "Max_ee_Hg", "Min_ase_Hg", "Max_ase_Hg",
			"Min_en_H", "Max_en_H", "Min_ee_H", "Max_ee_H", "Min_ase_H", "Max_ase_H", "Min_en_F", "Max_en_F",
			"Min_ee_F", "Max_ee_F", "Min_ase_F", "Max_ase_F", "Min_en_Cl", "Max_en_Cl", "Min_ee_Cl", "Max_ee_Cl",
			"Min_ase_Cl", "Max_ase_Cl", "Min_en_Br", "Max_en_Br", "Min_ee_Br", "Max_ee_Br", "Min_ase_Br", "Max_ase_Br",
			"Min_en_I", "Max_en_I", "Min_ee_I", "Max_ee_I", "Min_ase_I", "Max_ase_I", "Min_re_C_C", "Max_re_C_C",
			"Min_en_C_C", "Max_en_C_C", "Min_nn_C_C", "Max_nn_C_C", "Min_eee_C_C", "Max_eee_C_C", "Min_tie_C_C",
			"Max_tie_C_C", "Min_re_C_N", "Max_re_C_N", "Min_en_C_N", "Max_en_C_N", "Min_nn_C_N", "Max_nn_C_N",
			"Min_eee_C_N", "Max_eee_C_N", "Min_tie_C_N", "Max_tie_C_N", "Min_re_C_P", "Max_re_C_P", "Min_en_C_P",
			"Max_en_C_P", "Min_nn_C_P", "Max_nn_C_P", "Min_eee_C_P", "Max_eee_C_P", "Min_tie_C_P", "Max_tie_C_P",
			"Min_re_C_O", "Max_re_C_O", "Min_en_C_O", "Max_en_C_O", "Min_nn_C_O", "Max_nn_C_O", "Min_eee_C_O",
			"Max_eee_C_O", "Min_tie_C_O", "Max_tie_C_O", "Min_re_C_S", "Max_re_C_S", "Min_en_C_S", "Max_en_C_S",
			"Min_nn_C_S", "Max_nn_C_S", "Min_eee_C_S", "Max_eee_C_S", "Min_tie_C_S", "Max_tie_C_S", "Min_re_C_Si",
			"Max_re_C_Si", "Min_en_C_Si", "Max_en_C_Si", "Min_nn_C_Si", "Max_nn_C_Si", "Min_eee_C_Si", "Max_eee_C_Si",
			"Min_tie_C_Si", "Max_tie_C_Si", "Min_re_C_Hg", "Max_re_C_Hg", "Min_en_C_Hg", "Max_en_C_Hg", "Min_nn_C_Hg",
			"Max_nn_C_Hg", "Min_eee_C_Hg", "Max_eee_C_Hg", "Min_tie_C_Hg", "Max_tie_C_Hg", "Min_re_C_H", "Max_re_C_H",
			"Min_en_C_H", "Max_en_C_H", "Min_nn_C_H", "Max_nn_C_H", "Min_eee_C_H", "Max_eee_C_H", "Min_tie_C_H",
			"Max_tie_C_H", "Min_re_C_F", "Max_re_C_F", "Min_en_C_F", "Max_en_C_F", "Min_nn_C_F", "Max_nn_C_F",
			"Min_eee_C_F", "Max_eee_C_F", "Min_tie_C_F", "Max_tie_C_F", "Min_re_C_Cl", "Max_re_C_Cl", "Min_en_C_Cl",
			"Max_en_C_Cl", "Min_nn_C_Cl", "Max_nn_C_Cl", "Min_eee_C_Cl", "Max_eee_C_Cl", "Min_tie_C_Cl", "Max_tie_C_Cl",
			"Min_re_C_Br", "Max_re_C_Br", "Min_en_C_Br", "Max_en_C_Br", "Min_nn_C_Br", "Max_nn_C_Br", "Min_eee_C_Br",
			"Max_eee_C_Br", "Min_tie_C_Br", "Max_tie_C_Br", "Min_re_C_I", "Max_re_C_I", "Min_en_C_I", "Max_en_C_I",
			"Min_nn_C_I", "Max_nn_C_I", "Min_eee_C_I", "Max_eee_C_I", "Min_tie_C_I", "Max_tie_C_I", "Min_re_N_N",
			"Max_re_N_N", "Min_en_N_N", "Max_en_N_N", "Min_nn_N_N", "Max_nn_N_N", "Min_eee_N_N", "Max_eee_N_N",
			"Min_tie_N_N", "Max_tie_N_N", "Min_re_N_P", "Max_re_N_P", "Min_en_N_P", "Max_en_N_P", "Min_nn_N_P",
			"Max_nn_N_P", "Min_eee_N_P", "Max_eee_N_P", "Min_tie_N_P", "Max_tie_N_P", "Min_re_N_O", "Max_re_N_O",
			"Min_en_N_O", "Max_en_N_O", "Min_nn_N_O", "Max_nn_N_O", "Min_eee_N_O", "Max_eee_N_O", "Min_tie_N_O",
			"Max_tie_N_O", "Min_re_N_S", "Max_re_N_S", "Min_en_N_S", "Max_en_N_S", "Min_nn_N_S", "Max_nn_N_S",
			"Min_eee_N_S", "Max_eee_N_S", "Min_tie_N_S", "Max_tie_N_S", "Min_re_N_Si", "Max_re_N_Si", "Min_en_N_Si",
			"Max_en_N_Si", "Min_nn_N_Si", "Max_nn_N_Si", "Min_eee_N_Si", "Max_eee_N_Si", "Min_tie_N_Si", "Max_tie_N_Si",
			"Min_re_N_Hg", "Max_re_N_Hg", "Min_en_N_Hg", "Max_en_N_Hg", "Min_nn_N_Hg", "Max_nn_N_Hg", "Min_eee_N_Hg",
			"Max_eee_N_Hg", "Min_tie_N_Hg", "Max_tie_N_Hg", "Min_re_N_H", "Max_re_N_H", "Min_en_N_H", "Max_en_N_H",
			"Min_nn_N_H", "Max_nn_N_H", "Min_eee_N_H", "Max_eee_N_H", "Min_tie_N_H", "Max_tie_N_H", "Min_re_N_F",
			"Max_re_N_F", "Min_en_N_F", "Max_en_N_F", "Min_nn_N_F", "Max_nn_N_F", "Min_eee_N_F", "Max_eee_N_F",
			"Min_tie_N_F", "Max_tie_N_F", "Min_re_N_Cl", "Max_re_N_Cl", "Min_en_N_Cl", "Max_en_N_Cl", "Min_nn_N_Cl",
			"Max_nn_N_Cl", "Min_eee_N_Cl", "Max_eee_N_Cl", "Min_tie_N_Cl", "Max_tie_N_Cl", "Min_re_N_Br", "Max_re_N_Br",
			"Min_en_N_Br", "Max_en_N_Br", "Min_nn_N_Br", "Max_nn_N_Br", "Min_eee_N_Br", "Max_eee_N_Br", "Min_tie_N_Br",
			"Max_tie_N_Br", "Min_re_N_I", "Max_re_N_I", "Min_en_N_I", "Max_en_N_I", "Min_nn_N_I", "Max_nn_N_I",
			"Min_eee_N_I", "Max_eee_N_I", "Min_tie_N_I", "Max_tie_N_I", "Min_re_P_P", "Max_re_P_P", "Min_en_P_P",
			"Max_en_P_P", "Min_nn_P_P", "Max_nn_P_P", "Min_eee_P_P", "Max_eee_P_P", "Min_tie_P_P", "Max_tie_P_P",
			"Min_re_P_O", "Max_re_P_O", "Min_en_P_O", "Max_en_P_O", "Min_nn_P_O", "Max_nn_P_O", "Min_eee_P_O",
			"Max_eee_P_O", "Min_tie_P_O", "Max_tie_P_O", "Min_re_P_S", "Max_re_P_S", "Min_en_P_S", "Max_en_P_S",
			"Min_nn_P_S", "Max_nn_P_S", "Min_eee_P_S", "Max_eee_P_S", "Min_tie_P_S", "Max_tie_P_S", "Min_re_P_Si",
			"Max_re_P_Si", "Min_en_P_Si", "Max_en_P_Si", "Min_nn_P_Si", "Max_nn_P_Si", "Min_eee_P_Si", "Max_eee_P_Si",
			"Min_tie_P_Si", "Max_tie_P_Si", "Min_re_P_Hg", "Max_re_P_Hg", "Min_en_P_Hg", "Max_en_P_Hg", "Min_nn_P_Hg",
			"Max_nn_P_Hg", "Min_eee_P_Hg", "Max_eee_P_Hg", "Min_tie_P_Hg", "Max_tie_P_Hg", "Min_re_P_H", "Max_re_P_H",
			"Min_en_P_H", "Max_en_P_H", "Min_nn_P_H", "Max_nn_P_H", "Min_eee_P_H", "Max_eee_P_H", "Min_tie_P_H",
			"Max_tie_P_H", "Min_re_P_F", "Max_re_P_F", "Min_en_P_F", "Max_en_P_F", "Min_nn_P_F", "Max_nn_P_F",
			"Min_eee_P_F", "Max_eee_P_F", "Min_tie_P_F", "Max_tie_P_F", "Min_re_P_Cl", "Max_re_P_Cl", "Min_en_P_Cl",
			"Max_en_P_Cl", "Min_nn_P_Cl", "Max_nn_P_Cl", "Min_eee_P_Cl", "Max_eee_P_Cl", "Min_tie_P_Cl", "Max_tie_P_Cl",
			"Min_re_P_Br", "Max_re_P_Br", "Min_en_P_Br", "Max_en_P_Br", "Min_nn_P_Br", "Max_nn_P_Br", "Min_eee_P_Br",
			"Max_eee_P_Br", "Min_tie_P_Br", "Max_tie_P_Br", "Min_re_P_I", "Max_re_P_I", "Min_en_P_I", "Max_en_P_I",
			"Min_nn_P_I", "Max_nn_P_I", "Min_eee_P_I", "Max_eee_P_I", "Min_tie_P_I", "Max_tie_P_I", "Min_re_O_O",
			"Max_re_O_O", "Min_en_O_O", "Max_en_O_O", "Min_nn_O_O", "Max_nn_O_O", "Min_eee_O_O", "Max_eee_O_O",
			"Min_tie_O_O", "Max_tie_O_O", "Min_re_O_S", "Max_re_O_S", "Min_en_O_S", "Max_en_O_S", "Min_nn_O_S",
			"Max_nn_O_S", "Min_eee_O_S", "Max_eee_O_S", "Min_tie_O_S", "Max_tie_O_S", "Min_re_O_Si", "Max_re_O_Si",
			"Min_en_O_Si", "Max_en_O_Si", "Min_nn_O_Si", "Max_nn_O_Si", "Min_eee_O_Si", "Max_eee_O_Si", "Min_tie_O_Si",
			"Max_tie_O_Si", "Min_re_O_Hg", "Max_re_O_Hg", "Min_en_O_Hg", "Max_en_O_Hg", "Min_nn_O_Hg", "Max_nn_O_Hg",
			"Min_eee_O_Hg", "Max_eee_O_Hg", "Min_tie_O_Hg", "Max_tie_O_Hg", "Min_re_O_H", "Max_re_O_H", "Min_en_O_H",
			"Max_en_O_H", "Min_nn_O_H", "Max_nn_O_H", "Min_eee_O_H", "Max_eee_O_H", "Min_tie_O_H", "Max_tie_O_H",
			"Min_re_O_F", "Max_re_O_F", "Min_en_O_F", "Max_en_O_F", "Min_nn_O_F", "Max_nn_O_F", "Min_eee_O_F",
			"Max_eee_O_F", "Min_tie_O_F", "Max_tie_O_F", "Min_re_O_Cl", "Max_re_O_Cl", "Min_en_O_Cl", "Max_en_O_Cl",
			"Min_nn_O_Cl", "Max_nn_O_Cl", "Min_eee_O_Cl", "Max_eee_O_Cl", "Min_tie_O_Cl", "Max_tie_O_Cl", "Min_re_O_Br",
			"Max_re_O_Br", "Min_en_O_Br", "Max_en_O_Br", "Min_nn_O_Br", "Max_nn_O_Br", "Min_eee_O_Br", "Max_eee_O_Br",
			"Min_tie_O_Br", "Max_tie_O_Br", "Min_re_O_I", "Max_re_O_I", "Min_en_O_I", "Max_en_O_I", "Min_nn_O_I",
			"Max_nn_O_I", "Min_eee_O_I", "Max_eee_O_I", "Min_tie_O_I", "Max_tie_O_I", "Min_re_S_S", "Max_re_S_S",
			"Min_en_S_S", "Max_en_S_S", "Min_nn_S_S", "Max_nn_S_S", "Min_eee_S_S", "Max_eee_S_S", "Min_tie_S_S",
			"Max_tie_S_S", "Min_re_S_Si", "Max_re_S_Si", "Min_en_S_Si", "Max_en_S_Si", "Min_nn_S_Si", "Max_nn_S_Si",
			"Min_eee_S_Si", "Max_eee_S_Si", "Min_tie_S_Si", "Max_tie_S_Si", "Min_re_S_Hg", "Max_re_S_Hg", "Min_en_S_Hg",
			"Max_en_S_Hg", "Min_nn_S_Hg", "Max_nn_S_Hg", "Min_eee_S_Hg", "Max_eee_S_Hg", "Min_tie_S_Hg", "Max_tie_S_Hg",
			"Min_re_S_H", "Max_re_S_H", "Min_en_S_H", "Max_en_S_H", "Min_nn_S_H", "Max_nn_S_H", "Min_eee_S_H",
			"Max_eee_S_H", "Min_tie_S_H", "Max_tie_S_H", "Min_re_S_F", "Max_re_S_F", "Min_en_S_F", "Max_en_S_F",
			"Min_nn_S_F", "Max_nn_S_F", "Min_eee_S_F", "Max_eee_S_F", "Min_tie_S_F", "Max_tie_S_F", "Min_re_S_Cl",
			"Max_re_S_Cl", "Min_en_S_Cl", "Max_en_S_Cl", "Min_nn_S_Cl", "Max_nn_S_Cl", "Min_eee_S_Cl", "Max_eee_S_Cl",
			"Min_tie_S_Cl", "Max_tie_S_Cl", "Min_re_S_Br", "Max_re_S_Br", "Min_en_S_Br", "Max_en_S_Br", "Min_nn_S_Br",
			"Max_nn_S_Br", "Min_eee_S_Br", "Max_eee_S_Br", "Min_tie_S_Br", "Max_tie_S_Br", "Min_re_S_I", "Max_re_S_I",
			"Min_en_S_I", "Max_en_S_I", "Min_nn_S_I", "Max_nn_S_I", "Min_eee_S_I", "Max_eee_S_I", "Min_tie_S_I",
			"Max_tie_S_I", "Min_re_Si_Si", "Max_re_Si_Si", "Min_en_Si_Si", "Max_en_Si_Si", "Min_nn_Si_Si",
			"Max_nn_Si_Si", "Min_eee_Si_Si", "Max_eee_Si_Si", "Min_tie_Si_Si", "Max_tie_Si_Si", "Min_re_Si_Hg",
			"Max_re_Si_Hg", "Min_en_Si_Hg", "Max_en_Si_Hg", "Min_nn_Si_Hg", "Max_nn_Si_Hg", "Min_eee_Si_Hg",
			"Max_eee_Si_Hg", "Min_tie_Si_Hg", "Max_tie_Si_Hg", "Min_re_Si_H", "Max_re_Si_H", "Min_en_Si_H",
			"Max_en_Si_H", "Min_nn_Si_H", "Max_nn_Si_H", "Min_eee_Si_H", "Max_eee_Si_H", "Min_tie_Si_H", "Max_tie_Si_H",
			"Min_re_Si_F", "Max_re_Si_F", "Min_en_Si_F", "Max_en_Si_F", "Min_nn_Si_F", "Max_nn_Si_F", "Min_eee_Si_F",
			"Max_eee_Si_F", "Min_tie_Si_F", "Max_tie_Si_F", "Min_re_Si_Cl", "Max_re_Si_Cl", "Min_en_Si_Cl",
			"Max_en_Si_Cl", "Min_nn_Si_Cl", "Max_nn_Si_Cl", "Min_eee_Si_Cl", "Max_eee_Si_Cl", "Min_tie_Si_Cl",
			"Max_tie_Si_Cl", "Min_re_Si_Br", "Max_re_Si_Br", "Min_en_Si_Br", "Max_en_Si_Br", "Min_nn_Si_Br",
			"Max_nn_Si_Br", "Min_eee_Si_Br", "Max_eee_Si_Br", "Min_tie_Si_Br", "Max_tie_Si_Br", "Min_re_Si_I",
			"Max_re_Si_I", "Min_en_Si_I", "Max_en_Si_I", "Min_nn_Si_I", "Max_nn_Si_I", "Min_eee_Si_I", "Max_eee_Si_I",
			"Min_tie_Si_I", "Max_tie_Si_I", "Min_re_Hg_Hg", "Max_re_Hg_Hg", "Min_en_Hg_Hg", "Max_en_Hg_Hg",
			"Min_nn_Hg_Hg", "Max_nn_Hg_Hg", "Min_eee_Hg_Hg", "Max_eee_Hg_Hg", "Min_tie_Hg_Hg", "Max_tie_Hg_Hg",
			"Min_re_Hg_H", "Max_re_Hg_H", "Min_en_Hg_H", "Max_en_Hg_H", "Min_nn_Hg_H", "Max_nn_Hg_H", "Min_eee_Hg_H",
			"Max_eee_Hg_H", "Min_tie_Hg_H", "Max_tie_Hg_H", "Min_re_Hg_F", "Max_re_Hg_F", "Min_en_Hg_F", "Max_en_Hg_F",
			"Min_nn_Hg_F", "Max_nn_Hg_F", "Min_eee_Hg_F", "Max_eee_Hg_F", "Min_tie_Hg_F", "Max_tie_Hg_F",
			"Min_re_Hg_Cl", "Max_re_Hg_Cl", "Min_en_Hg_Cl", "Max_en_Hg_Cl", "Min_nn_Hg_Cl", "Max_nn_Hg_Cl",
			"Min_eee_Hg_Cl", "Max_eee_Hg_Cl", "Min_tie_Hg_Cl", "Max_tie_Hg_Cl", "Min_re_Hg_Br", "Max_re_Hg_Br",
			"Min_en_Hg_Br", "Max_en_Hg_Br", "Min_nn_Hg_Br", "Max_nn_Hg_Br", "Min_eee_Hg_Br", "Max_eee_Hg_Br",
			"Min_tie_Hg_Br", "Max_tie_Hg_Br", "Min_re_Hg_I", "Max_re_Hg_I", "Min_en_Hg_I", "Max_en_Hg_I", "Min_nn_Hg_I",
			"Max_nn_Hg_I", "Min_eee_Hg_I", "Max_eee_Hg_I", "Min_tie_Hg_I", "Max_tie_Hg_I", "Min_re_H_H", "Max_re_H_H",
			"Min_en_H_H", "Max_en_H_H", "Min_nn_H_H", "Max_nn_H_H", "Min_eee_H_H", "Max_eee_H_H", "Min_tie_H_H",
			"Max_tie_H_H", "Min_re_H_F", "Max_re_H_F", "Min_en_H_F", "Max_en_H_F", "Min_nn_H_F", "Max_nn_H_F",
			"Min_eee_H_F", "Max_eee_H_F", "Min_tie_H_F", "Max_tie_H_F", "Min_re_H_Cl", "Max_re_H_Cl", "Min_en_H_Cl",
			"Max_en_H_Cl", "Min_nn_H_Cl", "Max_nn_H_Cl", "Min_eee_H_Cl", "Max_eee_H_Cl", "Min_tie_H_Cl", "Max_tie_H_Cl",
			"Min_re_H_Br", "Max_re_H_Br", "Min_en_H_Br", "Max_en_H_Br", "Min_nn_H_Br", "Max_nn_H_Br", "Min_eee_H_Br",
			"Max_eee_H_Br", "Min_tie_H_Br", "Max_tie_H_Br", "Min_re_H_I", "Max_re_H_I", "Min_en_H_I", "Max_en_H_I",
			"Min_nn_H_I", "Max_nn_H_I", "Min_eee_H_I", "Max_eee_H_I", "Min_tie_H_I", "Max_tie_H_I", "Min_re_F_F",
			"Max_re_F_F", "Min_en_F_F", "Max_en_F_F", "Min_nn_F_F", "Max_nn_F_F", "Min_eee_F_F", "Max_eee_F_F",
			"Min_tie_F_F", "Max_tie_F_F", "Min_re_F_Cl", "Max_re_F_Cl", "Min_en_F_Cl", "Max_en_F_Cl", "Min_nn_F_Cl",
			"Max_nn_F_Cl", "Min_eee_F_Cl", "Max_eee_F_Cl", "Min_tie_F_Cl", "Max_tie_F_Cl", "Min_re_F_Br", "Max_re_F_Br",
			"Min_en_F_Br", "Max_en_F_Br", "Min_nn_F_Br", "Max_nn_F_Br", "Min_eee_F_Br", "Max_eee_F_Br", "Min_tie_F_Br",
			"Max_tie_F_Br", "Min_re_F_I", "Max_re_F_I", "Min_en_F_I", "Max_en_F_I", "Min_nn_F_I", "Max_nn_F_I",
			"Min_eee_F_I", "Max_eee_F_I", "Min_tie_F_I", "Max_tie_F_I", "Min_re_Cl_Cl", "Max_re_Cl_Cl", "Min_en_Cl_Cl",
			"Max_en_Cl_Cl", "Min_nn_Cl_Cl", "Max_nn_Cl_Cl", "Min_eee_Cl_Cl", "Max_eee_Cl_Cl", "Min_tie_Cl_Cl",
			"Max_tie_Cl_Cl", "Min_re_Cl_Br", "Max_re_Cl_Br", "Min_en_Cl_Br", "Max_en_Cl_Br", "Min_nn_Cl_Br",
			"Max_nn_Cl_Br", "Min_eee_Cl_Br", "Max_eee_Cl_Br", "Min_tie_Cl_Br", "Max_tie_Cl_Br", "Min_re_Cl_I",
			"Max_re_Cl_I", "Min_en_Cl_I", "Max_en_Cl_I", "Min_nn_Cl_I", "Max_nn_Cl_I", "Min_eee_Cl_I", "Max_eee_Cl_I",
			"Min_tie_Cl_I", "Max_tie_Cl_I", "Min_re_Br_Br", "Max_re_Br_Br", "Min_en_Br_Br", "Max_en_Br_Br",
			"Min_nn_Br_Br", "Max_nn_Br_Br", "Min_eee_Br_Br", "Max_eee_Br_Br", "Min_tie_Br_Br", "Max_tie_Br_Br",
			"Min_re_Br_I", "Max_re_Br_I", "Min_en_Br_I", "Max_en_Br_I", "Min_nn_Br_I", "Max_nn_Br_I", "Min_eee_Br_I",
			"Max_eee_Br_I", "Min_tie_Br_I", "Max_tie_Br_I", "Min_re_I_I", "Max_re_I_I", "Min_en_I_I", "Max_en_I_I",
			"Min_nn_I_I", "Max_nn_I_I", "Min_eee_I_I", "Max_eee_I_I", "Min_tie_I_I", "Max_tie_I_I", "Tot_1c_en",
			"Av_1c_en", "Tot_1c_ee", "Av_1c_ee", "Tot_2c_res", "Av_2c_res", "Tot_2c_exch", "Av_2c_exch", "Tot_2c_en",
			"Av_2c_en", "Tot_2c_ee", "Av_2c_ee", "pnsa1", "ppsa1", "pnsa2", "ppsa2", "pnsa3", "ppsa3", "dpsa1", "dpsa2",
			"dpsa3", "fnsa1", "fnsa2", "fnsa3", "fpsa1", "fpsa2", "fpsa3", "wnsa1", "wnsa2", "wnsa3", "wpsa1", "wpsa2",
			"wpsa3", "rncg", "rpcg", "rncs", "rpcs", "tasa", "tpsa", "rasa", "rpsa", "nhba", "nhbd", "rhta", "hdsa",
			"rsah", "fhdsa", "hasa", "hasa2", "rsaa", "fhasa", "fhasa2", "hdca", "csa2h", "csa2cl", "fhdca", "hdca2",
			"hdsa2", "haca", "scaa2", "fhaca", "hbsa", "fhbsa", "hbca", "fhbca", "chaa1", "chaa2", "acgd", "hrpcg",
			"hrncg", "hrpcs", "hrncs", "chgd", "vdWSA", "vdWV", "SASA", "SAV", "cesa", "cev", "ovality", "HOMO_2",
			"HOMO_1", "HOMO", "LUMO", "LUMO_1", "LUMO_2", "aoep_HOMO_2", "aoep_HOMO_1", "aoep_HOMO", "aoep_LUMO",
			"aoep_LUMO_1", "aoep_LUMO_2", "hardness", "HOMO_LUMO", "HOMLUM", "elect", "ip", "Dipole_charge",
			"Dipole_hybrid", "Dipole_X", "Dipole_Y", "Dipole_Z", "Dipole", "PMI_A", "PMI_B", "PMI_C", "apolar",
			"bpolar", "gpolar", "eccentricity", "asphericity", "sphericity" };
	...
	public void WriteToFileHTML(String OutputFolder, String filename) {
		try {
			FileWriter fw = new FileWriter(OutputFolder + File.separator + filename);

			fw.write("<html>\n");
			fw.write("<head>\n");
			fw.write("<title>Descriptor values\n");
			fw.write("</title>\n");
			fw.write("</head>\n");

			fw.write("<h2>");

//			if (molname instanceof String) {
//				if (this.molname.length()>0) {
//					fw.write(this.molname);
//				} else {
//					fw.write("untitled");
//				}
//			}
...
//					fw.write(" ("+this.CAS+")<br>");
//				}
				fw.write(this.ID + "<br>");
			}
			fw.write("</h2>\n");

			fw.write("<a href=\"" + ID + ".mol\">MDL molfile</a>\n");
			fw.write(
					"<br><a href=\"2d_descriptors.txt\">Descriptor text file</a> (\"|\" delimited, data listed in rows)\n");

			fw.write("<ol type=\"1\">\n"); // arabic numeral list
			// fw.write("<ol type=\"I\">\n");// roman numeral list

			this.WriteConstitutionalDescriptors(fw);
			this.WriteConnectivityIndices(fw);
			this.WriteKappas(fw);
			this.WriteEStates(fw);
			this.WriteFragments(fw);
			this.Write2D(fw);
			this.WriteInformationIndices(fw);
			;
			this.WriteBurdenEigenvalueDescriptors(fw);
			this.WriteTopologicalDescriptors(fw);
			this.WriteWalkandPathCounts(fw);
			this.Write2DAutocorrelationDescriptors(fw);
			this.WriteMolecularProperties(fw);
			this.WriteMolecularDistanceEdgeDescriptors(fw);

//			System.out.println("in dd, 3D="+ThreeD);
			// 3d:
			if (this.ThreeD) {
				this.WriteWHIMDescriptors(fw); // X
				this.WriteGETAWAYDescriptors(fw); // XII
				this.WriteMOMI(fw);
				this.WriteRandicMolecularProfiles(fw);
				this.WriteQuantumDescriptors(fw);
			}
	...
	public void WriteToFileHTML(String OutputFolder) {
		this.WriteToFileHTML(OutputFolder, "DescriptorData.html");
	}

	public void WriteToFileJSON(String outputfolder, boolean writeMultiline) {

		try {
			JsonObject jo = this.toJSON();

//			DescriptorData test=DescriptorData.toDescriptorData(jo);//test convert back
//			System.out.println(test.ALOGP);
			...
			FileWriter fw = new FileWriter(outputfolder + File.separator + "descriptorValues.json");
	...
	public void WriteToFileTEXT(String folderpath, String Delimiter) {
		WriteToFileTEXT("2d_descriptors.txt", folderpath, Delimiter);
	}

	/**
	 * Writes out descriptors to readable file for looking at all descriptors in a
	 * single vertical table
	 * 
	 * @param m
	 * @param dd
	 */
	public void WriteToFileTEXT(String filename, String folderpath, String Delimiter) {

		try {
			FileWriter fw = new FileWriter(folderpath + File.separator + filename);
	...
	/**
	 * Store as LinkedHashMap so values are in the same order as we put them in Also
	 * great for exporting later to csv *
	 * 
	 * @return
	 */
	...
	public static String getValue(String field, Vector<String> descriptorNames, Vector<String> vec) {
		...
		for (int i = 0; i < descriptorNames.size(); i++) {
			if (descriptorNames.get(i).contentEquals(field)) {
				return vec.get(i);
			}
		}
		return null;
	...
	void load3DDefs() {
		...
		try {
			...
			while (in.ready() && line != null) {
				...
				num.add(number); // Adds descriptor number to the
									// array
...
// System.out.println(myFile.exists());
			...
			while (true) {
				...
				this.htVarDef.put(strvar, strdef);
	...
	public DescriptorData() {
		...
		if (Load2dDescriptions)
			this.loadDefs("variable definitions.txt");
		if (this.LoadMy3dDescriptions)
			this.loadDefs("variable definitions-My3d.txt");
		if (this.LoadRaghu3dDescriptions)
			this.load3DDefs();

		// generate Estate count array:
		strES_acnt = new String[strES.length];
		for (int i = 0; i < strES.length; i++)
			strES_acnt[i] = strES[i] + "_acnt";

	}

	private void WriteHTMLLine(Object obj1, String strVar, FileWriter fw, String format) {

		DecimalFormat d4 = new DecimalFormat(format);
		try {
			Field myField = obj1.getClass().getField(strVar);
			double d1 = myField.getDouble(obj1);
			fw.write("\t<td>" + d4.format(d1) + "</td>\n");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void WriteConnectivityIndices(FileWriter fw) {

		try {
			fw.write("<h2><li>Chi Connectivity Indices</li></h2>\n");

			fw.write("<table border=\"1\" cellpadding=\"3\" cellspacing=\"0\">\n");

			fw.write("<tr bgcolor=\"#D3D3D3\">\n");
			fw.write("\t<th>Length</th>\n");
			...
			// fw.write("\t<th rowspan=\"2\">Error</th>\n");
			...
			for (int i = 0; i <= 10; i++) {
				...
				this.WriteHTMLLine(this, this.strxp[i], fw, "0.0000");

				// ****************************************************
				// write cluster values:
				if (i == 3 || i == 4) {
					strVar = "xc" + i;
					this.WriteHTMLLine(this, strVar, fw, "0.0000");
				} else {
					fw.write("\t<td><br></td>\n");
				}
				// ****************************************************
				// write path cluster values
				if (i == 4) {
					this.WriteHTMLLine(this, "xpc4", fw, "0.0000");
				} else {
					fw.write("\t<td><br></td>\n");
...
//				****************************************************
				// Write path values (valence)
				this.WriteHTMLLine(this, this.strxvp[i], fw, "0.0000");

				// ****************************************************
//				write cluster values (valence):
				if (i == 3 || i == 4) {
					strVar = "xvc" + i;
					this.WriteHTMLLine(this, strVar, fw, "0.0000");
				} else {
...
//				****************************************************
			...
			// next table for knotp and knotpv:
			fw.write("<table border=\"1\" cellpadding=\"3\" cellspacing=\"0\">\n");
			...
			this.WriteHTMLLine3(this, "knotp", fw);
			this.WriteHTMLLine3(this, "knotpv", fw);
	...
	private void WriteKappas(FileWriter fw) {
		try {
			fw.write("<h2><li>Kappa Shape Indices</li></h2>\n");
			...
			fw.write("\t<th>Kappa</th>\n");
			fw.write("\t<th>Kappa Alpha</th>\n");
			...
			for (int i = 1; i <= 3; i++) {
				...
				// ****************************************************
				// Write kappa values
				this.WriteHTMLLine(this, "k" + i, fw, "0.0000");

//			 Write kappa alpha values
				if (i == 0) {
					fw.write("\t<td><br></td>\n");
				} else {
					this.WriteHTMLLine(this, "ka" + i, fw, "0.0000");
				}
			...
			// next table for phia:
			fw.write("<br><table border=\"1\" cellpadding=\"3\" cellspacing=\"0\">\n");
			...
			this.WriteHTMLLine3(this, "phia", fw);
			fw.write("</table>\n");
	...
	private void WriteWHIMDescriptors(FileWriter fw) {

		String[] ws = { "u", "m", "v", "p", "e", "s" };

		try {
			fw.write("<h2><li>WHIM descriptors</li></h2>\n");
			fw.write("<br><table border=\"1\" cellpadding=\"3\" cellspacing=\"0\">\n");

			fw.write("<tr bgcolor=\"#D3D3D3\">\n");
			fw.write("\t<th rowspan=\"2\">Parameter</th>\n");
			fw.write("\t<th colspan=\"" + ws.length + "\">Weighting scheme</th>\n");
			fw.write("</tr>\n");
			...
			this.WriteWeightRow("L1", ws, fw);
			this.WriteWeightRow("L2", ws, fw);
			this.WriteWeightRow("L3", ws, fw);

			this.WriteWeightRow("P1", ws, fw);
			this.WriteWeightRow("P2", ws, fw);

			this.WriteWeightRow("G1", ws, fw);
			this.WriteWeightRow("G2", ws, fw);
			this.WriteWeightRow("G3", ws, fw);

			this.WriteWeightRow("E1", ws, fw);
			this.WriteWeightRow("E2", ws, fw);
			this.WriteWeightRow("E3", ws, fw);

			this.WriteWeightRow("T", ws, fw);
			this.WriteWeightRow("A", ws, fw);

			String strVar = "G";
			fw.write("<tr>\n");
			fw.write("<td>" + strVar + "</td>\n");

			for (int i = 0; i <= ws.length - 1; i++) {
				if (ws[i].equals("u") || ws[i].equals("m") || ws[i].equals("s")) {
					this.WriteHTMLLine(this, strVar + ws[i], fw, "0.000");
				} else {
					fw.write("\t<td><br></td>\n");
				}
			}

			this.WriteWeightRow("K", ws, fw);
			this.WriteWeightRow("D", ws, fw);
			this.WriteWeightRow("V", ws, fw);
	...
	private void WriteWeightRow(String strVar, String[] ws, FileWriter fw) {
		try {
			fw.write("<tr>\n");
			fw.write("<td>" + strVar + "</td>\n");
	...
	private void WriteGETAWAYDescriptors(FileWriter fw) {
		try {

			fw.write("<h2><li>GETAWAY descriptors</li></h2>\n");
			fw.write("<br><table border=\"1\" cellpadding=\"3\" cellspacing=\"0\">\n");
			...
			this.WriteHTMLLine3(this, "HGM", fw);
			this.WriteHTMLLine3(this, "ITH", fw);
			this.WriteHTMLLine3(this, "ISH", fw);
			this.WriteHTMLLine3(this, "HIC", fw);
			this.WriteHTMLLine3(this, "RARS", fw);
			this.WriteHTMLLine3(this, "RCON", fw);
			this.WriteHTMLLine3(this, "REIG", fw);
			fw.write("</table>\n");

			fw.write("<br><table border=\"1\" cellpadding=\"3\" cellspacing=\"0\">\n");
			fw.write("<caption>H-GETAWAY Descriptors</caption>\n");
			fw.write("<tr bgcolor=\"#D3D3D3\">\n");
			fw.write("\t<th>Lag</th>\n");

			fw.write("\t<th>Hu</th>\n");
			fw.write("\t<th>HATSu</th>\n");

			fw.write("\t<th>Hm</th>\n");
			fw.write("\t<th>HATSm</th>\n");

			fw.write("\t<th>Hv</th>\n");
			fw.write("\t<th>HATSv</th>\n");

			fw.write("\t<th>Hp</th>\n");
			fw.write("\t<th>HATSp</th>\n");

			fw.write("\t<th>He</th>\n");
			fw.write("\t<th>HATSe</th>\n");
			...
			for (int i = 0; i <= 8; i++) {
				...
				// ****************************************************
				// write autocorrelation of lag i / unweighted
				this.WriteHTMLLine(this, "H" + i + "u", fw, "0.000");

				// write leverage-weighted autocorrelation of lag i
				this.WriteHTMLLine(this, "HATS" + i + "u", fw, "0.000");

//				 write autocorrelation of lag i / weighted by mass
				this.WriteHTMLLine(this, "H" + i + "m", fw, "0.000");

				// write leverage-weighted autocorrelation of lag i / weighted by mass
				this.WriteHTMLLine(this, "HATS" + i + "m", fw, "0.000");

//				 write autocorrelation of lag i / weighted by volume
				this.WriteHTMLLine(this, "H" + i + "v", fw, "0.000");

				// write leverage-weighted autocorrelation of lag i / weighted by volume
				this.WriteHTMLLine(this, "HATS" + i + "v", fw, "0.000");

//				 write autocorrelation of lag i / weighted by polarizability
				this.WriteHTMLLine(this, "H" + i + "p", fw, "0.000");

				// write leverage-weighted autocorrelation of lag i / weighted by mass
				this.WriteHTMLLine(this, "HATS" + i + "p", fw, "0.000");

//				 write autocorrelation of lag i / weighted by electronegativity
				this.WriteHTMLLine(this, "H" + i + "e", fw, "0.000");

				// write leverage-weighted autocorrelation of lag i / weighted by
				// electronegativity
				this.WriteHTMLLine(this, "HATS" + i + "e", fw, "0.000");
			...
			this.WriteHTMLLine(this, "HTu", fw, "0.000");
			this.WriteHTMLLine(this, "HATSu", fw, "0.000");

			this.WriteHTMLLine(this, "HTm", fw, "0.000");
			this.WriteHTMLLine(this, "HATSm", fw, "0.000");

			this.WriteHTMLLine(this, "HTv", fw, "0.000");
			this.WriteHTMLLine(this, "HATSv", fw, "0.000");

			this.WriteHTMLLine(this, "HTp", fw, "0.000");
			this.WriteHTMLLine(this, "HATSp", fw, "0.000");

			this.WriteHTMLLine(this, "HTe", fw, "0.000");
			this.WriteHTMLLine(this, "HATSe", fw, "0.000");
...
// R table:
			fw.write("<br><table border=\"1\" cellpadding=\"3\" cellspacing=\"0\">\n");
			fw.write("<caption>R-GETAWAY Descriptors</caption>\n");
			fw.write("<tr bgcolor=\"#D3D3D3\">\n");
			fw.write("\t<th>Lag</th>\n");

			fw.write("\t<th>Ru</th>\n");
			fw.write("\t<th>Ruplus</th>\n");

			fw.write("\t<th>Rm</th>\n");
			fw.write("\t<th>Rmplus</th>\n");

			fw.write("\t<th>Rv</th>\n");
			fw.write("\t<th>Rvplus</th>\n");

			fw.write("\t<th>Rp</th>\n");
			fw.write("\t<th>Rpplus</th>\n");

			fw.write("\t<th>Re</th>\n");
			fw.write("\t<th>Replus</th>\n");
			...
			for (int i = 1; i <= 8; i++) {
				...
				// ****************************************************
				// write autocorrelation of lag i / unweighted
				this.WriteHTMLLine(this, "R" + i + "u", fw, "0.000");

				// write leverage-weighted autocorrelation of lag i
				this.WriteHTMLLine(this, "R" + i + "uplus", fw, "0.000");

//				 write autocorrelation of lag i / weighted by mass
				this.WriteHTMLLine(this, "R" + i + "m", fw, "0.000");

				// write leverage-weighted autocorrelation of lag i / weighted by mass
				this.WriteHTMLLine(this, "R" + i + "mplus", fw, "0.000");

//				 write autocorrelation of lag i / weighted by volume
				this.WriteHTMLLine(this, "R" + i + "v", fw, "0.000");

				// write leverage-weighted autocorrelation of lag i / weighted by volume
				this.WriteHTMLLine(this, "R" + i + "vplus", fw, "0.000");

//				 write autocorrelation of lag i / weighted by polarizability
				this.WriteHTMLLine(this, "R" + i + "p", fw, "0.000");

				// write leverage-weighted autocorrelation of lag i / weighted by mass
				this.WriteHTMLLine(this, "R" + i + "pplus", fw, "0.000");

//				 write autocorrelation of lag i / weighted by electronegativity
				this.WriteHTMLLine(this, "R" + i + "e", fw, "0.000");

				// write leverage-weighted autocorrelation of lag i / weighted by
				// electronegativity
				this.WriteHTMLLine(this, "R" + i + "eplus", fw, "0.000");
			...
			this.WriteHTMLLine(this, "RTu", fw, "0.000");
			this.WriteHTMLLine(this, "RTuplus", fw, "0.000");

			this.WriteHTMLLine(this, "RTm", fw, "0.000");
			this.WriteHTMLLine(this, "RTmplus", fw, "0.000");

			this.WriteHTMLLine(this, "RTv", fw, "0.000");
			this.WriteHTMLLine(this, "RTvplus", fw, "0.000");

			this.WriteHTMLLine(this, "RTp", fw, "0.000");
			this.WriteHTMLLine(this, "RTpplus", fw, "0.000");

			this.WriteHTMLLine(this, "RTe", fw, "0.000");
			this.WriteHTMLLine(this, "RTeplus", fw, "0.000");
	...
	private void Write2D(FileWriter fw) {
		try {
			fw.write("<h2><li>2D Molecular Properties</li></h2>\n");
			...
			for (int i = 0; i <= this.str2D.length - 1; i++) {
				this.WriteHTMLLine3(this, this.str2D[i], fw);
			}
	...
	private void WriteMOMI(FileWriter fw) {
		try {
			fw.write("<h2><li>Principal moment of inertia</li></h2>\n");
			...
			for (int i = 0; i <= this.strMOMI.length - 1; i++) {
				this.WriteHTMLLine3(this, this.strMOMI[i], fw);
			}
	...
	private void WriteConstitutionalDescriptors(FileWriter fw) {
		try {
			fw.write("<h2><li>Constitutional Descriptors</li></h2>\n");
			...
			for (int i = 0; i <= this.strCon.length - 1; i++) {
				this.WriteHTMLLine4(this, this.strCon[i], fw);
			}
	...
	private void WriteMolecularDistanceEdgeDescriptors(FileWriter fw) {
		try {
			fw.write("<h2><li>Molecular Distance Edge Descriptors</li></h2>\n");
			...
			for (int i = 0; i <= this.strMDEC.length - 1; i++) {
				this.WriteHTMLLine4(this, this.strMDEC[i], fw);
			}
	...
	private void WriteInformationIndices(FileWriter fw) {
		try {
			fw.write("<h2><li>Information Indexes</li></h2>\n");
			...
			for (int i = 0; i <= this.strIC.length - 1; i++) {
				this.WriteHTMLLine4(this, strIC[i], fw);
			}
	...
	private void WriteWalkandPathCounts(FileWriter fw) {
		try {
			fw.write("<h2><li>Walk and path counts</li></h2>\n");
			...
			for (int i = 1; i <= 10; i++) {
				...
				// ****************************************************
				// Write molecular walk counts
				this.WriteHTMLLine(this, strVar, fw, "0.000");

				// write self returning walk counts:
				strVar = "SRW" + strNum;
				this.WriteHTMLLine(this, strVar, fw, "0");

				// write molecular paths counts:
				strVar = "MPC" + strNum;
				this.WriteHTMLLine(this, strVar, fw, "0");

				// write multiple path counts:
				strVar = "piPC" + strNum;
				this.WriteHTMLLine(this, strVar, fw, "0.000");
...
//			 next table for CID, BID:
			...
			this.WriteHTMLLine3(this, "TWC", fw);
			this.WriteHTMLLine3(this, "TPC", fw);
			this.WriteHTMLLine3(this, "piID", fw);
			this.WriteHTMLLine3(this, "CID", fw);
			this.WriteHTMLLine3(this, "CID2", fw);
			this.WriteHTMLLine3(this, "BID", fw);
			fw.write("</table>\n");
	...
	private void WriteRandicMolecularProfiles(FileWriter fw) {
		try {
			fw.write("<h2><li>Randic Molecular Profiles</li></h2>\n");

			fw.write("<table border=\"1\" cellpadding=\"3\" cellspacing=\"0\">\n");

			fw.write("<tr bgcolor=\"#D3D3D3\">\n");
			fw.write("\t<th>Power</th>\n");
			fw.write("\t<th>DP</th>\n");
			fw.write("\t<th>SP</th>\n");
			fw.write("</tr>\n");

//			System.out.println(this.DP01);
			...
			this.WriteHTMLLine3(this, "SHP2", fw);
			fw.write("</table>\n");
	...
	private void WriteTopologicalDescriptors(FileWriter fw) {
		try {
			fw.write("<h2><li>Topological descriptors</h2></li>\n");
			...
			for (int i = 0; i <= this.strTopo.length - 1; i++) {
				this.WriteHTMLLine4(this, this.strTopo[i], fw);
			}
	...
	private void WriteBurdenEigenvalueDescriptors(FileWriter fw) {
		try {
			fw.write("<h2><li>Burden eigenvalue descriptors</li></h2>\n");
			...
			for (int i = 1; i <= 8; i++) {
				...
				this.WriteHTMLLine(this, "BEHm" + i, fw, "0.000");
				this.WriteHTMLLine(this, "BELm" + i, fw, "0.000");

				this.WriteHTMLLine(this, "BEHv" + i, fw, "0.000");
				this.WriteHTMLLine(this, "BELv" + i, fw, "0.000");

				this.WriteHTMLLine(this, "BEHe" + i, fw, "0.000");
				this.WriteHTMLLine(this, "BELe" + i, fw, "0.000");

				this.WriteHTMLLine(this, "BEHp" + i, fw, "0.000");
				this.WriteHTMLLine(this, "BELp" + i, fw, "0.000");
	...
	private void Write2DAutocorrelationDescriptors(FileWriter fw) {
		try {
			fw.write("<h2><li>2D Autocorrelation Descriptors</li></h2>\n");
			...
			fw.write("\t<th>MATSm</th>\n");
			fw.write("\t<th>MATSv</th>\n");
			fw.write("\t<th>MATSe</th>\n");
			fw.write("\t<th>MATSp</th>\n");

			fw.write("\t<th>GATSm</th>\n");
			fw.write("\t<th>GATSv</th>\n");
			fw.write("\t<th>GATSe</th>\n");
			fw.write("\t<th>GATSp</th>\n");
			...
			for (int i = 1; i <= 8; i++) {
				...
				this.WriteHTMLLine(this, "ATS" + i + "m", fw, "0.000");
				this.WriteHTMLLine(this, "ATS" + i + "v", fw, "0.000");
				this.WriteHTMLLine(this, "ATS" + i + "e", fw, "0.000");
				this.WriteHTMLLine(this, "ATS" + i + "p", fw, "0.000");

				this.WriteHTMLLine(this, "MATS" + i + "m", fw, "0.000");
				this.WriteHTMLLine(this, "MATS" + i + "v", fw, "0.000");
				this.WriteHTMLLine(this, "MATS" + i + "e", fw, "0.000");
				this.WriteHTMLLine(this, "MATS" + i + "p", fw, "0.000");

				this.WriteHTMLLine(this, "GATS" + i + "m", fw, "0.000");
				this.WriteHTMLLine(this, "GATS" + i + "v", fw, "0.000");
				this.WriteHTMLLine(this, "GATS" + i + "e", fw, "0.000");
				this.WriteHTMLLine(this, "GATS" + i + "p", fw, "0.000");
	...
	private void WriteEStates(FileWriter fw) {

		DecimalFormat d4 = new DecimalFormat("0.0000");

		try {
			fw.write("<h2><li>III.	Electrotopological State Indices</li></h2>\n");
			fw.write("<a href=\"estates.html\">Estates for each atom</a>\n");
			fw.write("<table>\n");
			fw.write("<tr>\n");
			fw.write("<td>\n");
			...
			for (int i = 0; i <= this.strES.length - 1; i++) {

				myField = this.getClass().getField(this.strES[i]);
				double d1 = myField.getDouble(this);

				myField = this.getClass().getField(this.strES[i] + "_acnt");
				int i1 = myField.getInt(this);

				if (i1 > 0) {

					fw.write("<tr>\n");
					fw.write("\t<td>" + this.strES[i] + "</td>\n");
					fw.write("\t<td>" + d4.format(d1) + "</td>\n");
					fw.write("\t<td>" + i1 + "</td>\n");
			...
			for (int i = 0; i <= this.strHES.length - 1; i++) {

				myField = this.getClass().getField(this.strHES[i]);
				double d1 = myField.getDouble(this);

				if (d1 > 0) {

					fw.write("<tr>\n");
					fw.write("\t<td>" + this.strHES[i] + "</td>\n");
					fw.write("\t<td>" + d4.format(d1) + "</td>\n");
			...
			this.WriteHTMLLine2(this, "Hmax", fw);
			this.WriteHTMLLine2(this, "Gmax", fw);

			this.WriteHTMLLine2(this, "Hmin", fw);
			this.WriteHTMLLine2(this, "Gmin", fw);

			fw.write("</table>\n");
			fw.write("</td>\n");

			fw.write("<td>\n");
			fw.write("<img src=\"structure.png\">\n");
			fw.write("</td>\n");
	...
	private void WriteMolecularProperties(FileWriter fw) {
		try {
			fw.write("<h2><li>Molecular Properties</li></h2>\n");
			...
			for (int i = 0; i <= this.strMP.length - 1; i++) {
				this.WriteHTMLLine4(this, this.strMP[i], fw);
			}
	...
	private void WriteFragments(FileWriter fw) {

		try {
			fw.write("<h2><li><a name=Fragments>Fragments</a></li></h2>\n");

			fw.write("<a href=\"AssignedFragments.html\">Assigned fragments for each atom</a>\n");

			if (!(FragmentList instanceof Hashtable)) {
				fw.write("<b>Note: Fragments weren't calculated</b>\n");
				return;
			}
			...
			// String fragnames=(String)this.FragmentList.get(0);
			// List namelist=Utilities.Parse(fragnames,"|");

			Vector<String> v = new Vector<>(FragmentList.keySet());
			
			for (Enumeration<String> e = v.elements(); e.hasMoreElements();) {
				// retrieve the object_key
				String object_key = (String) e.nextElement();
				// retrieve the object associated with the key
				double object_val = (Double) FragmentList.get(object_key);

				if (object_val > 0) {
					fw.write("<tr>\n");
					fw.write("\t<td>" + object_key + "</td>\n");
					fw.write("\t<td>" + object_val + "</td>\n");
					fw.write("</tr>\n");
				}
...
//			for ( Enumeration e = FragmentList.keys() ; e.hasMoreElements() ; ) {
//
//				// 	retrieve the object_key
//				String object_key = (String) e.nextElement();
//				// 	retrieve the object associated with the key
...
//			for (java.util.Enumeration e=this.FragmentList.keys(); e.hasMoreElements() ;) {
//		         String var=(String)e.nextElement();
//
//		         double val=(Double)this.FragmentList.get(var);;
//
//		         if (val>0) {
//						fw.write("<tr>\n");
//						fw.write("\t<td>"+var+"</td>\n");
...
//				Integer fragval=(Integer)this.FragmentList.get(i+1);
//
//				if (fragval>0) {
//					fw.write("<tr>\n");
//					fw.write("\t<td>"+namelist.get(i)+"</td>\n");
//					fw.write("\t<td>"+fragval+"</td>\n");
//					//System.out.println(namelist.get(i)+"\t"+fragval);
//					fw.write("</tr>\n");
//				}
//
//			}
	...
	void WriteHTMLLine2(Object obj1, String strVar, FileWriter fw) {
		DecimalFormat d4 = new DecimalFormat("0.0000");
	...
	void WriteHTMLLine3(Object obj1, String strVar, FileWriter fw) {
		DecimalFormat d4 = new DecimalFormat("0.0000");
	...
	void WriteHTMLLine4(Object obj1, String strVar, FileWriter fw) {
		DecimalFormat d4 = new DecimalFormat("0.0000");
		...
		try {
			...
			fw.write("\t<td>" + d4.format(d1) + "</td>\n");
			if (this.htVarDef.get(strVar) instanceof String) {
				fw.write("\t<td>" + this.htVarDef.get(strVar) + "</td>\n");
			} else {
				fw.write("\t<td><br></td>\n");
			}
	...
	private void WriteQuantumDescriptors(FileWriter fw) {
		try {
			fw.write("<h2><li>3D (Quantum Chemistry-based) Descriptors</li></h2>\n");
			...
			for (int i = 0; i <= this.strQM.length - 1; i++) {
				this.WriteHTMLLine4(this, this.strQM[i], fw);
			}

//	    File file = new File("ToxPredictor/temp/desc3d.txt");
//    	String line;
//    	StringTokenizer token;
//    	BufferedReader in = new BufferedReader(new FileReader(file));
//    	line = in.readLine(); //contains the values
//    	double number;
//		ArrayList num = new ArrayList(); //List to store the descriptor number
//
//
//    	while (in.ready() && line != null) {
//    		token = new StringTokenizer(line, "\t,;");
//    		number = (new Double(token.nextToken())).doubleValue();
//    		num.add(new Double(number)); //Adds descriptor value to the array
//    		line = in.readLine(); //Read the next line
//    	} //while in.ready()
//    	in.close();
////	}//if file.exists()
...
//
//	    for (int i=0;i<=this.strQM.length-1;i++) {
//	    	this.WriteHTMLLine5((Double) num.get(i+1),this.strQM[i],fw);
//	    }
//
			fw.write("</table>\n");
			fw.flush();
	...
	void WriteHTMLLine5(double value, String strVar, FileWriter fw) {
		double d1;
		DecimalFormat d4 = new DecimalFormat("0.0000");
	...
	public String[] CreateVarList(boolean include2D, boolean includeFrag, boolean include3D, boolean includeRaghu3D,
			boolean includeKOWWIN) {
		ArrayList<String> varList = new ArrayList<>();
		varList.add("CAS");
		varList.add("Tox");

		if (include2D)
			this.PutVarNamesInArray(varList, this.varlist2d);

		if (includeFrag) {
			for(String fragment:FragmentList.keySet()) varList.add(fragment);
		}

		if (include3D)
			this.PutVarNamesInArray(varList, this.varlist3d);

		if (includeRaghu3D)
			this.PutVarNamesInArray2(varList, this.strQM);
	...
	public String[] CreateVarListFDA_Subset() {
		ArrayList<String> varList = new ArrayList<>();
		varList.add("CAS");
		varList.add("Tox");

		this.PutVarNamesInArray2(varList, strChi);
		this.PutVarNamesInArray2(varList, strKappa);
		this.PutVarNamesInArray2(varList, strES);
		this.PutVarNamesInArray2(varList, strES_acnt);
		this.PutVarNamesInArray2(varList, strHES);
		this.PutVarNamesInArray2(varList, strESMaxMin);
		this.PutVarNamesInArray2(varList, str2D);
		this.PutVarNamesInArray2(varList, strCon);
		this.PutVarNamesInArray2(varList, strMP);
	...
	public Hashtable<String, Object> CreateDataHashtable(boolean include2D, boolean includeFrag, boolean include3D,
			boolean includeRaghu3D, boolean includeKOWWIN) {
		...
		if (include2D)
			PutValuesInHashTable(ht, this.varlist2d);

		if (includeFrag)
			PutFragmentValuesInHashTable(ht);

		if (include3D)
			PutValuesInHashTable(ht, this.varlist3d);

		if (includeRaghu3D)
			PutValuesInHashTable2(ht, this.strQM);

		if (includeKOWWIN)
			ht.put("KLOGP", this.KLOGP);

		return ht;

	}

	public Hashtable<String, Object> CreateDataHashtable(String ToxFieldName, boolean include2D, boolean includeFrag,
			boolean include3D, boolean includeRaghu3D, boolean includeKOWWIN) {

		Hashtable<String, Object> ht = new Hashtable<>();

		ht.put("CAS", ID);
		ht.put(ToxFieldName, -9999.0);
	...
	public Hashtable<String, Object> CreateDataHashtableFDASubSet() {
		...
		PutValuesInHashTable2(ht, strChi);
		PutValuesInHashTable2(ht, strKappa);
		PutValuesInHashTable2(ht, strES);
		PutValuesInHashTable2(ht, strES_acnt);
		PutValuesInHashTable2(ht, strHES);
		PutValuesInHashTable2(ht, strESMaxMin);
		PutValuesInHashTable2(ht, str2D);
		PutValuesInHashTable2(ht, strCon);
		PutValuesInHashTable2(ht, strMP);

		return ht;

	}

	public void DisplayDataHashtableValues(Hashtable<String,Object> ht, String[] varNames) {

		for (int i = 0; i < varNames.length; i++) {
			System.out.println(varNames[i] + "\t" + ht.get(varNames[i]));
		}
	}

	private void PutFragmentValuesInHashTable(Hashtable <String, Object>ht) {
//		Vector<String> v = new Vector<>(FragmentList.keySet());
////	    for now dont sort since CSV files for Paul werent sorted
////		Collections.sort(v); //quick way to sort by frag names
//
//		for (Enumeration e = v.elements(); e.hasMoreElements();) {
//			// retrieve the object_key
//			String object_key = (String) e.nextElement();
//			// retrieve the object associated with the key
//			double object_val = FragmentList.get(object_key);
//
//			ht.put(object_key, object_val);
//		}
		
		for(String fragment:FragmentList.keySet()) {
			ht.put(fragment, FragmentList.get(fragment));
		}
	 ...
	 *
	 * @param ht
	 * @param varList = array of array names
	 */
	private void PutValuesInHashTable(Hashtable<String,Object>ht, String[] ArrayOfArrayNames) {
		try {
			for (int i = 0; i <= ArrayOfArrayNames.length - 1; i++) {
				// System.out.println(dd.varlist2d[i]);

				Field myField = this.getClass().getField(ArrayOfArrayNames[i]);

				String[] varList = (String[]) myField.get(this);

				this.PutValuesInHashTable2(ht, varList);
			}
	 ...
	 * @param varList = array of array names
	 */
	private void PutValuesInHashTable2(Hashtable<String,Object> ht, String[] varList) {
		try {
			for (int j = 0; j < varList.length; j++) {
				String var = varList[j];
				Field myField2 = this.getClass().getField(var);
				double val = myField2.getDouble(this);
//				if (var.equals("SddssS_acnt")) {
//					System.out.println("For SddssS_acnt, val="+val);
//				}
	...
	private void PutVarNamesInArray(ArrayList<String> varList, String[] ArrayOfArrayNames) {
		try {
			for (int i = 0; i <= ArrayOfArrayNames.length - 1; i++) {
				Field myField = this.getClass().getField(ArrayOfArrayNames[i]);
				String[] varArray = (String[]) myField.get(this);
				PutVarNamesInArray2(varList, varArray);
			}
	...
	private void PutVarNamesInArray2(ArrayList<String> varList, String[] varArray) {
		for (int j = 0; j < varArray.length; j++) {
			varList.add(varArray[j]);
		}
	}

	public String to_JSON_String(boolean writeMultiline) {
	 ...
	 * @param dd
	 */
	public void WriteJSON(String outputFilePath, boolean writeMultiline) {

		try {
			String strJSON = to_JSON_String(writeMultiline);
	...
	public JsonObject toJSON() {
		...
		try {
			...
			JsonObject metadata = new JsonObject();// store as separate object to make converting back to DescriptorData
			metadata.addProperty("CAS", this.ID);
			metadata.addProperty("molname", this.molname);
			metadata.addProperty("SoftwareVersion", TESTConstants.SoftwareVersion);
			metadata.addProperty("error", this.Error);
			metadata.addProperty("InChiKey", this.InChiKey);
			metadata.addProperty("InChi", this.InChi);
			metadata.addProperty("InChi_Warning", this.InChi_Warning);
			metadata.addProperty("SMILES", this.SmilesRan);

			record.add("metadata", metadata);

			if (Error != null && !Error.equals("OK")) {
				// To avoid getting a null error later stop here:
				return record;
			}

			JsonObject nonFragmentDescriptors = new JsonObject();// store as separate object to make converting back to
																	// DescriptorData
			record.add("non fragment descriptors", nonFragmentDescriptors);
			...
			for (int i = 0; i <= this.varlist2d.length - 1; i++) {
				...
				for (int j = 0; j <= names.length - 1; j++) {
					...
					if (myField2.getType().toString().equals("double")) {
						nonFragmentDescriptors.addProperty(names[j], myField2.getDouble(this));
					} else if (myField2.getType().toString().equals("int")) {
						nonFragmentDescriptors.addProperty(names[j], myField2.getInt(this));
					} else {
			...
			JsonObject fragmentDescriptors = new JsonObject();// store as separate object to make converting back to
																// DescriptorData
			record.add("fragment descriptors", fragmentDescriptors);

			for (int i = 0; i < DescriptorData.strFragments.length; i++) {
				String strVar = DescriptorData.strFragments[i];
				double Val = (Double) this.FragmentList.get(strVar);

//				record.addProperty(strVar, Val);
				fragmentDescriptors.addProperty(strVar, Val);
			}
	...
	public static DescriptorData loadFromJSON(File descFile, String CAS) {
		DescriptorData dd = loadFromJSON(descFile);
		if (dd != null)
			dd.ID = CAS;
		return dd;
	}
	...
	/**
	 * This version assumes that the CAS is stored in the metadata in the json file
	 * 
	 * @param descFile
	 * @return
	 */
	public static DescriptorData loadFromJSON(File descFile) {
		Gson gson = new Gson();
		try {
			JsonObject jo = gson.fromJson(new FileReader(descFile), JsonObject.class);
			DescriptorData dd = toDescriptorData(jo);

//			dd.MW_Frag=0;//for testing

			if (dd.MW_Frag == 0) {
				dd.MW_Frag = CalculateMWFrags.calculateMW_Frag(dd);
//				System.out.println(dd.MW+"\t"+dd.MW_Frag);
			}
	 ...
	 * @return
	 */
	public static DescriptorData loadFromJSON(String strJSON) {
		Gson gson = new Gson();
		try {
...
//			dd.MW_Frag=0;//for testing
			...
			if (dd.MW_Frag == 0) {// Shouldnt need this going forward since stored from now on
				dd.MW_Frag = CalculateMWFrags.calculateMW_Frag(dd);
//				System.out.println(dd.MW+"\t"+dd.MW_Frag);
			}
	...
	/**
	 * Converts JSON object to DescriptorData object
	 *
	 * @param jo
	 * @return
	 */
	public static DescriptorData toDescriptorData(JsonObject jo) {

		try {

			JsonObject metadata = jo.getAsJsonObject("metadata");
			JsonObject nonFragmentDescriptors = jo.getAsJsonObject("non fragment descriptors");
			JsonObject fragmentDescriptors = jo.getAsJsonObject("fragment descriptors");

			DescriptorData dd = new DescriptorData();

			dd.ID = metadata.get("CAS").getAsString();
			dd.molname = metadata.get("molname").getAsString();
			dd.SoftwareVersion = metadata.get("SoftwareVersion").getAsString();
			dd.Error = metadata.get("error").getAsString();
			dd.InChiKey = metadata.get("InChiKey").getAsString();
			dd.InChi = metadata.get("InChi").getAsString();
			dd.InChi_Warning = metadata.get("InChi_Warning").getAsString();
			if (metadata.get("SMILES") != null)
				dd.SmilesRan = metadata.get("SMILES").getAsString();

			if (!dd.Error.equals("OK")) {
				return dd;
			}

//			System.out.println(dd.SoftwareVersion);

			for (int i = 0; i <= dd.varlist2d.length - 1; i++) {
				Field myField = dd.getClass().getField(dd.varlist2d[i]);
				String[] names = (String[]) myField.get(dd);
				for (int j = 0; j <= names.length - 1; j++) {
					Field myField2 = dd.getClass().getField(names[j]);
					JsonElement je = nonFragmentDescriptors.get(names[j]);

					if (myField2.getType().toString().equals("double")) {
						myField2.setDouble(dd, je.getAsDouble());
//						System.out.println(names[j]+"\t"+je.getAsDouble());
					} else if (myField2.getType().toString().equals("int")) {
						myField2.setInt(dd, je.getAsInt());
//						System.out.println(names[j]+"\t"+je.getAsInt());
					} else {
						System.out.println(myField2.getType());
					}
				}
			...
			dd.FragmentList = new Hashtable<>();

			for (String fragment:DescriptorData.strFragments) {
				JsonElement je = fragmentDescriptors.get(fragment);
				double Val = je.getAsDouble();
				dd.FragmentList.put(fragment, Val);
//				System.out.println(dd.strFragments[i]+"\t"+Val);
			}

			if (!fragmentDescriptors.get("MW_Frag").isJsonNull())
				dd.MW_Frag = fragmentDescriptors.get("MW_Frag").getAsDouble();
	...
	public static Vector<String> getDescriptorNames() {
		...
		try {
			...
			for (int i = 0; i < DescriptorData.strFragments.length; i++) {
				vecNames.add(DescriptorData.strFragments[i]);
			}
