	...
	void downloadWebPagesFromCASList(String textFilePath,String destFolderPath) {
		...
		try {								
			...
			for (String CAS:casList) {
				String strURL="https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/name/"+CAS+"/JSON";
...
//				System.out.println(name);
	...
	public static void main(String[] args) {
		...
		GetPubChemData g=new GetPubChemData();
