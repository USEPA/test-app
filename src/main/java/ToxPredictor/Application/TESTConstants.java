...
public class TESTConstants {
	public static String SoftwareVersion = "5.2.1";
...
//	Endpoints:
	...
	public static final int typeRunEndpoint=1;
	public static final int typeRunAA=2;
...
//	public static String strReportTypeSummary="Summary";
//	public static String strReportTypeWeb="Web report";
//	public static String strReportTypeDetailedWeb="Detailed web report";
//	public static String strReportTypeExcel="Excel report";
	...
	public static String getFullMethod(String abbrevMethod) {
		if (abbrevMethod.equalsIgnoreCase(abbrevChoiceHierarchicalMethod)) {
			...
			return ChoiceGroupContributionMethod;
		} else if (abbrevMethod.equalsIgnoreCase(abbrevChoiceLDA)) {
			return ChoiceLDA;
		} else if (abbrevMethod.equalsIgnoreCase(abbrevChoiceConsensus)) {
			return ChoiceConsensus;
		} else {
